...
<g:set var="checkCons" value="${contextOrg?.id == subscriptionInstance.getConsortia()?.id && subscriptionInstance._getCalculatedType() in [CalculatedType.TYPE_PARTICIPATION, CalculatedType.TYPE_PARTICIPATION_AS_COLLECTIVE]}" />
<g:set var="checkColl" value="${contextOrg?.id == subscriptionInstance.getCollective()?.id && subscriptionInstance._getCalculatedType() in [CalculatedType.TYPE_PARTICIPATION]}" />
