    ...
    static Map<String, Object> getCustomImplRefdata(String key, Class clazz) {
        ...
        if (key == CUSTOM_IMPL_KEY_SUBJECT_GROUP) {
            ...
            return [
                    ...
                    label: messageSource.getMessage('package.scope.label', null, locale),
