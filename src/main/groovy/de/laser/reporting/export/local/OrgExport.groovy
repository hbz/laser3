            ...
            base : [
                    ...
                    fields : [
                            default: [
                                    ...
                                    '+sortname+name'    : [ FIELD_TYPE_COMBINATION, 'x' ],
                                    ...
                                    '@-org-contact'     : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    'x-identifier'      : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    '@-org-accessPoint' : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    '@-org-readerNumber': [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
