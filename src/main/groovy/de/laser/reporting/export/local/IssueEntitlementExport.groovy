            ...
            base : [
                    ...
                    fields : [
                            default: [
                                    ...
                                    '@-entitlement-tippName'              : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    '@-entitlement-tippTitleType'         : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    'medium'                              : [ FIELD_TYPE_REFDATA, '@' ],
                                    'acceptStatus'                        : [ FIELD_TYPE_REFDATA, '@' ],
                                    'status'                              : [ FIELD_TYPE_REFDATA, '@' ],
                                    '@-entitlement-tippFirstAuthor'       : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    '@-entitlement-tippEditionStatement'  : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    '@-entitlement-tippPublisherName'     : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    '@-entitlement-tippSeriesName'        : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    '@-entitlement-tippFirstEditor'       : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    '@-entitlement-tippOpenAccessX'       : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    '@-entitlement-tippDeweyDecimalClassification' : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    '@-entitlement-tippLanguage'          : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    '@-entitlement-tippSubjectReference'  : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    '@-entitlement-tippProvider+sortname+name' : [ FIELD_TYPE_COMBINATION, 'x' ],
                                    '@-entitlement-tippPackage'           : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    '@-entitlement-tippPlatform'          : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    '@-entitlement-tippHostPlatformURL'   : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    '@-entitlement-tippIdentifier'        : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    '@-entitlement-priceItem'             : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                            ]
                    ]
            ]
    ]
