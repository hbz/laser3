            ...
            base : [
                    ...
                    fields : [
                            default: [
                                    ...
                                    'org+sortname+name'     : [ FIELD_TYPE_COMBINATION, 'x' ],
                                    'primaryUrl'            : [ FIELD_TYPE_PROPERTY, 'x' ],
                                    'serviceProvider'       : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    'softwareProvider'      : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    'status'                : [ FIELD_TYPE_REFDATA, '@' ],
                                    'ipAuthentication'             : [ FIELD_TYPE_ELASTICSEARCH, 'x' ],
                                    'shibbolethAuthentication'     : [ FIELD_TYPE_ELASTICSEARCH, 'x' ],
                                    'passwordAuthentication'       : [ FIELD_TYPE_ELASTICSEARCH, 'x' ],
                                    'proxySupported'               : [ FIELD_TYPE_ELASTICSEARCH, 'x' ],
                                    'statisticsFormat'             : [ FIELD_TYPE_ELASTICSEARCH, 'x' ],
                                    'statisticsUpdate'             : [ FIELD_TYPE_ELASTICSEARCH, 'x' ],
                                    'counterCertified'             : [ FIELD_TYPE_ELASTICSEARCH, 'x' ],
                                    'counterR3Supported'           : [ FIELD_TYPE_ELASTICSEARCH, 'x' ],
                                    'counterR4Supported'           : [ FIELD_TYPE_ELASTICSEARCH, 'x' ],
                                    'counterR4SushiApiSupported'   : [ FIELD_TYPE_ELASTICSEARCH, 'x' ],
                                    'counterR5Supported'           : [ FIELD_TYPE_ELASTICSEARCH, 'x' ],
                                    'counterR5SushiApiSupported'   : [ FIELD_TYPE_ELASTICSEARCH, 'x' ],
