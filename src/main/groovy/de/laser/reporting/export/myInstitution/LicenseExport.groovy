            ...
            base : [
                    ...
                    fields : [
                            default: [
                                    ...
                                    '@-license-subscriptionCount'       : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    '@-license-memberCount'             : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
                                    '@-license-memberSubscriptionCount' : [ FIELD_TYPE_CUSTOM_IMPL, 'x' ],
