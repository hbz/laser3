        ...
        if (checkMap.containsKey(lsmnic)) {
            ...
            if (!check) {
                if (attrs.affiliation && attrs.orgPerm) {
                    if (user.is_ROLE_ADMIN_or_hasAffiliation(attrs.affiliation) && accessService.checkCtxPerm(attrs.orgPerm)) {
                        check = true
                    }
                }
                ...
                else if (attrs.orgPerm && accessService.checkCtxPerm(attrs.orgPerm)) {
                    check = true
                }
