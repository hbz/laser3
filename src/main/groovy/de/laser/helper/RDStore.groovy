...
class RDStore {
    ...
    public static final TIPP_PAYMENT_COMPLIMENTARY     = getRefdataValue('Complimentary', RDConstants.TIPP_ACCESS_TYPE)
    public static final TIPP_PAYMENT_LIMITED_PROMOTION = getRefdataValue('Limited Promotion', RDConstants.TIPP_ACCESS_TYPE)
    public static final TIPP_PAYMENT_PAID              = getRefdataValue('Paid', RDConstants.TIPP_ACCESS_TYPE)
    public static final TIPP_PAYMENT_OA                = getRefdataValue('OA', RDConstants.TIPP_ACCESS_TYPE)
    public static final TIPP_PAYMENT_OPT_OUT_PROMOTION = getRefdataValue('Opt Out Promotion', RDConstants.TIPP_ACCESS_TYPE)
    public static final TIPP_PAYMENT_UNCHARGED         = getRefdataValue('Uncharged', RDConstants.TIPP_ACCESS_TYPE)
    public static final TIPP_PAYMENT_UNKNOWN           = getRefdataValue('Unknown', RDConstants.TIPP_ACCESS_TYPE)
