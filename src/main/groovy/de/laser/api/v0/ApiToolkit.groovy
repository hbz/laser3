...
class ApiToolkit {
    ...
    static void setApiLevel(Org org, String apiLevel) {
        ...
        if (oss != OrgSetting.SETTING_NOT_FOUND) {
            ...
            OrgSetting.add(org, OrgSetting.KEYS.API_KEY, RandomUtils.getRandomAlphabetic(24))
            OrgSetting.add(org, OrgSetting.KEYS.API_PASSWORD, RandomUtils.getRandomAlphabetic(24))
        }
    }
