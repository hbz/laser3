...
class ApiCostItem {
    ...
    static Map<String, Object> getCostItemMap(CostItem costItem, Org context, boolean isInvoiceTool){
        ...
        result.subPkg   = ApiStubReader.requestSubscriptionPackageStubMixed(SubscriptionPackage.findBySubscriptionAndPkg(costItem.sub, costItem.subPkg), ApiReader.IGNORE_SUBSCRIPTION, context) // de.laser.SubscriptionPackage
