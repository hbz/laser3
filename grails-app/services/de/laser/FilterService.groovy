...
class FilterService {
    ...
    Map<String, Object> prepareTitleSQLQuery(Map configMap, String entitlementInstance, Sql sql) {
         ...
         */
        String query = "", join = "", where = "", orderClause = "", refdata_value_col = configMap.format == 'kbart' ? 'rdv_value' : I10nTranslation.getRefdataValueColumn(LocaleContextHolder.getLocale())
