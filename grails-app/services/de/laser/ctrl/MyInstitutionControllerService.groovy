...
class MyInstitutionControllerService {
    ...
    Map<String, Object> dashboard(MyInstitutionController controller, GrailsParameterMap params) {
        ...
        //Map<String,Object> pendingChangeConfigMap = [contextOrg:result.institution,consortialView:accessService.hasPermForOrg('ORG_CONSORTIUM_BASIC', result.institution),periodInDays:periodInDays,max:result.max,offset:result.acceptedOffset]
