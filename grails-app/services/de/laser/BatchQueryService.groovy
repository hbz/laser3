    ...
    void bulkAddHolding(Sql sql, Long subId, Long pkgId, boolean hasPerpetualAccess, Long consortiumId = null, Long sourceSubId = null) {
        ...
        if(consortiumId) {
            ...
            for(int i = 0; i < total.size(); i += bulkStep) {
                ...
                sql.executeInsert("insert into issue_entitlement (ie_version, ie_laser_id, ie_date_created, ie_last_updated, ie_subscription_fk, ie_tipp_fk, ie_access_start_date, ie_access_end_date, ie_status_rv_fk ${perpetualAccessColHeader}) " +
            ...
            for(int i = 0; i < totalIEs.size(); i += bulkStep) {
                ...
                sql.executeInsert("insert into issue_entitlement (ie_version, ie_laser_id, ie_date_created, ie_last_updated, ie_subscription_fk, ie_tipp_fk, ie_access_start_date, ie_access_end_date, ie_status_rv_fk, ie_notes ${perpetualAccessColHeader}) " +
                ...
                sql.executeInsert("insert into price_item (pi_version, pi_ie_fk, pi_local_price, pi_local_currency_rv_fk, pi_date_created, pi_last_updated, pi_laser_id) " +
            ...
            for(int i = 0; i < total.size(); i += bulkStep) {
                ...
                sql.executeInsert("insert into price_item (pi_version, pi_ie_fk, pi_date_created, pi_last_updated, pi_laser_id) " +
