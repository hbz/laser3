...
class CustomerTypeService {
    ...
    public static final String ORG_INST_BASIC           = 'ORG_BASIC'
    public static final String ORG_INST_PRO             = 'ORG_PRO'
    ...
    public static final String PERMS_INST_BASIC_CONSORTIUM_PRO  = 'ORG_BASIC,ORG_CONSORTIUM_PRO'
    public static final String PERMS_INST_PRO_CONSORTIUM_BASIC  = 'ORG_PRO,ORG_CONSORTIUM_BASIC'
