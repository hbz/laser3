...
''')
    ...
    void setIdentifierNamespace() {
        ...
        List<Map<String,Object>> namespaces = [
            ...
            [ns: "DBS-ID", name_de: "DBS-ID", description_de: "ID in der Deutschen und Österreichischen Bibliotheksstatistik (DBS/ÖBS)", name_en: "DBS-ID", description_en: "ID in the German and Austrian library statistic (DBS/ÖBS)", nsType: IdentifierNamespace.NS_ORGANISATION, urlPrefix: "https://www.bibliotheksstatistik.de/", isUnique: false, isHidden: false],
            ...
            [ns: "ezb_collection_id", name_de: "EZB-Kollektions-ID", description_de: null, name_en: "EZB collection id", description_en: null, nsType: IdentifierNamespace.NS_SUBSCRIPTION, urlPrefix: "http://ezb.ur.de/api/collections/", isUnique: false, isHidden: false],
            ...
            [ns: "Rechnungssystem_Nummer", name_de: "Rechnungssystem-Nr.", description_de: "Individuelle, interne Rechnungsnummer, vergeben von der einzelnen Einrichtungen", name_en: "Invoice system number", description_en: "Unique internal invoice system number, assigned by the respective institutions", nsType: IdentifierNamespace.NS_SUBSCRIPTION, isUnique: false, isHidden: false],
