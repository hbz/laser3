...
''')
    ...
    void setIdentifierNamespace() {
        ...
        List<Map<String,Object>> namespaces = [
            ...
            [ns: "ISIL", name_de: "ISIL", description_de: "International Standard Identifier for Libraries and Related Organizations, entspricht dem Bibliothekssigel der Sigelstelle. Sind der Einrichtung mehrere ISIL zugeordnet ist Mehrfachangabe möglich", name_en: "ISIL", description_en: null, nsType: IdentifierNamespace.NS_ORGANISATION, isUnique: false, isHidden: false],
