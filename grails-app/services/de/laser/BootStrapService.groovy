...
''')
    ...
    void setIdentifierNamespace() {
        ...
        List<Map<String,Object>> namespaces = [
            ...
            [ns: "fid_negotiator_id", name_de: "FID-Verhandlungs-ID", "description_de": null, "name_en": "FID negotiator ID", description_en: null, nsType: IdentifierNamespace.NS_SUBSCRIPTION, isUnique: false, isHidden: false],
