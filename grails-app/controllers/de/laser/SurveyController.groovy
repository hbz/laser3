...
class SurveyController {
    ...
    Map<String, Object> currentSurveysConsortia() {
        ...
        result.editable = accessService.checkConstraint_INST_EDITOR_PERM_X_RA( CustomerTypeService.ORG_CONSORTIUM_PRO )
    ...
    @Secured(closure = {
        ctx.accessService.checkConstraint_INST_EDITOR_PERM_X_RA( CustomerTypeService.ORG_CONSORTIUM_PRO )
    })
