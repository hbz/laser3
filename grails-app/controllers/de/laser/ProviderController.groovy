...
class ProviderController {
    ...
    def show() {
        ...
        if(params.containsKey('id')) {
            ...
            result.allPlatforms = allPackages.findAll { Package pkg -> pkg.nominalPlatform && pkg.nominalPlatform.status != RDStore.PLATFORM_STATUS_REMOVED }.nominalPlatform.toSet()
