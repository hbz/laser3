...
class VendorController {
    ...
    def findVendorMatches() {
        ...
        if ( params.proposedVendor ) {
            ...
            result.vendorMatches= Vendor.executeQuery("from Vendor as v where (genfunc_filter_matcher(v.name, :searchName) = true or genfunc_filter_matcher(v.abbreviatedName, :searchName) = true or exists(select a from v.altnames a where genfunc_filter_matcher(a.name, :searchName) = true)) ",
