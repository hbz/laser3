...
class MyInstitutionController  {
     ...
     */
    @DebugInfo(perm="ORG_INST,ORG_CONSORTIUM_BASIC", affil="INST_EDITOR")
    @Secured(closure = {
        ctx.accessService.checkPermAffiliation("ORG_INST,ORG_CONSORTIUM_BASIC", "INST_EDITOR")
    })
    def emptyLicense() {
        Map<String, Object> result = myInstitutionControllerService.getResultGenerics(this, params)
...
//            orgIds = matches.collect{ it.id }
    ...
    def currentTitles() {
        ...
        if(params.exportKBart) {
            ...
            String consFilter = result.institution.getCustomerType() in ['ORG_CONSORTIUM_BASIC', 'ORG_CONSORTIUM_PRO'] ? ' and s.instanceOf is null' : ''
     ...
     */
    @DebugInfo(perm="ORG_MEMBER_BASIC", affil="INST_USER", specRole="ROLE_ADMIN")
    @Secured(closure = {
        ctx.accessService.checkPermAffiliationX("ORG_MEMBER_BASIC", "INST_USER", "ROLE_ADMIN")
    })
    def currentSurveys() {
        Map<String, Object> result = myInstitutionControllerService.getResultGenerics(this, params)
     ...
     */
    @DebugInfo(perm="ORG_MEMBER_BASIC", affil="INST_EDITOR", specRole="ROLE_ADMIN")
    @Secured(closure = {
        ctx.accessService.checkPermAffiliationX("ORG_MEMBER_BASIC", "INST_EDITOR", "ROLE_ADMIN")
    })
     ...
     * @see CostItemGroup
     */
    @DebugInfo(perm="ORG_INST,ORG_CONSORTIUM_BASIC", affil="INST_USER", specRole="ROLE_ADMIN", wtc = DebugInfo.WITH_TRANSACTION)
    @Secured(closure = {
        ctx.accessService.checkPermAffiliationX("ORG_INST,ORG_CONSORTIUM_BASIC", "INST_USER", "ROLE_ADMIN")
    })
     ...
     * @see Task
     */
    @DebugInfo(perm="ORG_INST,ORG_CONSORTIUM_BASIC", affil="INST_USER", wtc = DebugInfo.IN_BETWEEN)
...
/*        List<Subscription> subscriptions = []
     ...
     */
    @DebugInfo(perm = "ORG_INST,ORG_CONSORTIUM_BASIC", affil = "INST_EDITOR", wtc = DebugInfo.WITH_TRANSACTION)
    @Secured(closure = {
        ctx.accessService.checkPermAffiliation("ORG_INST,ORG_CONSORTIUM_BASIC", "INST_EDITOR")
    })
