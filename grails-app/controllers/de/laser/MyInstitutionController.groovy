    ...
    def manageConsortiaSubscriptions() {
        ...
        */
        ...
        if(params.exportXLS) {
            ...
            List titles = [message(code:'sidewide.number'),message(code:'myinst.consortiaSubscriptions.member'), message(code:'org.mainContact.label'),message(code:'default.subscription.label'),message(code:'default.uuid.label'),
