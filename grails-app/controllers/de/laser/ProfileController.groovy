...
class ProfileController {
    ...
    def index() {
        ...
        result.isOrgBasicMember = contextService.getOrg().getCustomerType() == 'ORG_MEMBER_BASIC'
    ...
    def updateNotificationSettings() {
        ...
        String messageToken = ((contextService.getOrg().getCustomerType()  in ['ORG_CONSORTIUM_BASIC', 'ORG_CONSORTIUM_PRO']) ? 'profile.notification.for.SurveysParticipationFinish' : 'profile.notification.for.SurveysParticipationFinish2')
