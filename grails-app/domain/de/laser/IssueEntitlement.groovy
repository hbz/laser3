...
class IssueEntitlement extends AbstractBase implements Comparable {
    ...
    static mapping = {
         ...
         globalUID column:'ie_guid'
          ...
          sortname column:'ie_sortname', type: 'text'
            status column:'ie_status_rv_fk', index: 'ie_status_idx, ie_status_accept_status_idx'
      subscription column:'ie_subscription_fk', index: 'ie_sub_idx, ie_sub_tipp_idx, ie_status_accept_status_idx'
    ...
    accessStartDate column:'ie_access_start_date'
     accessEndDate column:'ie_access_end_date'
      ...
      acceptStatus column:'ie_accept_status_rv_fk', index: 'ie_accept_status_idx, ie_status_accept_status_idx'
