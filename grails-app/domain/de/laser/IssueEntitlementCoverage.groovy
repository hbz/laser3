...
/**
 * The coverage record for a local journal holding entry. The fields are the same as in {@link de.laser.wekb.TIPPCoverage} as all of them may differ from the global level
 * (see {@link IssueEntitlement} vs. {@link de.laser.wekb.TitleInstancePackagePlatform})
 */
