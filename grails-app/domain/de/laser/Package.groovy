...
static hasMany = [  tipps:     TitleInstancePackagePlatform,
  ...
  static mapping = {
             ...
             contentType column:'pkg_content_type_rv_fk',   index:'pkg_content_type_idx'
           packageStatus column:'pkg_status_rv_fk',         index:'pkg_status_idx'
                    file column:'pkg_file_rv_fk',           index:'pkg_file_idx'
               breakable column:'pkg_breakable_rv_fk',      index:'pkg_breakable_idx'
              consistent column:'pkg_consistent_rv_fk',     index:'pkg_consistent_idx'
         nominalPlatform column:'pkg_nominal_platform_fk',  index:'pkg_nominal_platform_idx'
                provider column:'pkg_provider_fk',  index:'pkg_provider_idx' //was orgRole with pkg != null
               startDate column:'pkg_start_date',   index:'pkg_dates_idx'
                ...
                isPublic column:'pkg_is_public'
                   scope column:'pkg_scope_rv_fk',  index:'pkg_scope_idx'
