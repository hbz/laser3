...
<laser:htmlStart message="subscription.details.linkTitle.label" />
...
<ui:breadcrumbs>
    ...
    <ui:crumb class="active" text="${message(code: 'subscription.details.linkTitle.label')}"/>
</ui:breadcrumbs>
...
<h2 class="ui icon header la-clear-before la-noMargin-top">${message(code: 'subscription.details.linkTitle.heading')}</h2>
<br/>
<br/>
