...
<ui:subNav actionName="${actionName}">
    ...
    <ui:securedSubNavItem affiliation="INST_USER" orgPerm="${CustomerTypeService.PERMS_PRO}" controller="subscription" action="tasks" params="${[id:params.id]}" counts="${tasksCount}" message="task.plural" />
