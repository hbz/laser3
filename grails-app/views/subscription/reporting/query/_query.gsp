<%@ page import="de.laser.ui.Button; de.laser.ui.Icon; de.laser.reporting.report.myInstitution.base.BaseConfig; de.laser.reporting.report.local.SubscriptionReport" %>
<div class="ui segment form">
    ...
    <div class="fields three">
        ...
        <div class="field" style="text-align: right">
            ...
            <button id="query-export-button" class="${Button.BASIC_ICON}" data-href="#queryExportModal" data-ui="modal" disabled><i class="${Icon.CMD.DOWNLOAD}"></i></button>
            <button id="query-help-button" class="${Button.BASIC_ICON}" data-href="#queryHelpModal" data-ui="modal" disabled><i class="${Icon.UI.HELP}"></i></button>
        </div>
    </div>
