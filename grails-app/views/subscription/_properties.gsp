...
<ui:modal id="propDefGroupBindings" message="propertyDefinitionGroup.config.label" hideSubmitButton="true">
    ...
    <laser:render template="/templates/properties/groupBindings" model="${[
            ...
            ownobj: subscription,
            editable: accessService.checkPermAffiliation(CustomerTypeService.PERMS_ORG_PRO_CONSORTIUM_BASIC,'INST_EDITOR'),
    ...
    <div class="content">
        ...
        <div id="custom_props_div_props">
            <laser:render template="/templates/properties/custom" model="${[
                    ...
                    editable: (!calledFromSurvey && accessService.checkPermAffiliation(CustomerTypeService.PERMS_ORG_PRO_CONSORTIUM_BASIC,'INST_EDITOR')),
