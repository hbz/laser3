...
<ui:modal id="linkPackageModal" message="myinst.currentSubscriptions.link_pkg"
    ...
    <g:form class="ui form" id="linkPackageForm" url="[controller: 'subscription', action: 'processLinkPackage', id: params.id]">
        ...
        <div class="field">
            <label for="holdingSelection">${message(code: 'subscription.holdingSelection.label')} <span class="la-long-tooltip la-popup-tooltip la-delay" data-content="${message(code: "subscription.holdingSelection.explanation")}"><i class="${Icons.HELP_TOOLTIP}"></i></span></label>
        </div>
        ...
        --%>
                ...
                <div class="inline field">
                    <label for="freezeHolding"><g:message code="subscription.packages.freezeHolding"/> <span class="la-popup-tooltip la-delay" data-content="${message(code: 'subscription.packages.freezeHolding.expl')}"><i class="${Icons.HELP_TOOLTIP}"></i></span></label>
            ...
            <g:if test="${institution.isCustomerType_Consortium()}">
                <div class="${colCount} wide column">
                    ...
                    <div class="inline field">
                        <label for="freezeHoldingAudit"><g:message code="subscription.packages.freezeHolding"/> <span class="la-popup-tooltip la-delay" data-content="${message(code: 'subscription.packages.freezeHolding.expl')}"><i class="${Icons.HELP_TOOLTIP}"></i></span></label>
