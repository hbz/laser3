...
<html>
    ...
    <body>
                    ...
                    <div class="field">
                        ...
                        <select name="metricType" id="metricType" multiple="multiple" class="ui selection dropdown">
                            ...
                            <g:each in="${metricTypes}" var="metricType">
                                <option <%=(params.list('reportType')?.contains(metricType)) ? 'selected="selected"' : ''%>
                                        value="${metricType}">
                                    <g:message code="default.usage.${metricType}"/>
                                </option>
                            </g:each>
                        </select>
                    </div>
        ...
        <div class="ui bottom attached tab active segment">
            <g:if test="${sums}">
                <semui:tabs>
                    <g:each in="${availableReports}" var="reportType">
                        <semui:tabsItem controller="subscription" action="stats" params="${params + [tab: 'total', reportType: reportType]}" text="${message(code: 'default.usage.'+reportType)}" subTab="reportType" tab="${reportType}"/>
                    </g:each>
                </semui:tabs>
                <div class="ui bottom attached tab active segment">
