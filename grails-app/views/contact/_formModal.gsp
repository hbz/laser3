<%@ page import="de.laser.ui.Icon; de.laser.Org;de.laser.RefdataCategory; de.laser.Person;de.laser.Contact;de.laser.storage.RDConstants" %>
    ...
    <g:form id="newContact" name="newContact" class="ui form" url="[controller: 'contact', action: 'createContact']" method="POST">
        ...
        <g:if test="${!prsId}">
            <div class="field">
                ...
                <g:if test="${orgId}">
                    <i class="${Icon.ORG} la-list-icon"></i>${Org.findById(orgId)}
