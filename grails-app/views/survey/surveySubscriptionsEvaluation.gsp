...
<laser:htmlStart text="${message(code: 'survey.label')} (${message(code: 'surveySubscriptionsEvaluation.label')})" />
...
<div class="ui bottom attached tab segment active">
    ...
    <g:set var="tmplConfigShowList" value="${['lineNumber', 'name', 'surveySubscriptions', 'surveyCostItemsSubscriptions', 'commentOnlyForOwner']}"/>
...
<laser:script file="${this.getGroovyPageFileName()}">
                ...
                feature: {
                    saveAsImage: {},
                     mySortToggle: {
                        ...
                        onclick: function (){
                            window.location.replace("<g:createLink controller="survey" action="surveySubscriptionsEvaluation" params="[id: params.id, surveyConfigID: surveyConfig.id, tab: params.tab]"/>"+'&chartSort=X');
                        }
                    },
                }
            },
  ...
  yAxis: {  name: "${g.message(code: 'surveySubscriptions.selectedSubscriptions')}", type: 'category' },
  series: [
    {
      type: 'bar',
      encode: {
