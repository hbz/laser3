...
<semui:modal id="${modalID}" text="Excel-Export" hideSubmitButton="true">
    ...
    <g:form controller="survey" action="surveyEvaluation" id="${surveyInfo.id}"
        ...
        <g:render template="/templates/export/individuallyExportForm" model="${[formFields: formFields, exportFileName: escapeService.escapeString(surveyConfig.getSurveyName()) + "_" + message(code:'surveyResult.label')]}"/>
