<%@ page import="de.laser.ui.Button; de.laser.ui.Icon; de.laser.survey.SurveyConfig; de.laser.survey.SurveyOrg; de.laser.interfaces.CalculatedType; de.laser.storage.RDStore; de.laser.properties.PropertyDefinition; de.laser.RefdataCategory; de.laser.RefdataValue; de.laser.Org; de.laser.Subscription" %>
                            ...
                            <td>
                                ...
                                <g:if test="${sub._getCalculatedPreviousForSurvey()}">
                                    ...
                                    <g:link controller="subscription" action="show"
                                            ...
                                            class="${Button.BASIC_ICON}"><i class="${Icon.SUBSCRIPTION} yellow"></i></g:link>
                                </g:if>
                            </td>
                    </tr>
                </g:each>
