<%@ page import="de.laser.helper.RDConstants; de.laser.helper.RDStore; de.laser.properties.PropertyDefinition;de.laser.RefdataCategory;de.laser.RefdataValue;de.laser.Org;de.laser.SurveyOrg" %>
                    ...
                    <div class="eight wide column">
                        <h3 class="ui header center aligned">
                            ...
                            <g:if test="${parentSuccessorSubscription}">
                                ...
                                <semui:totalNumber
                                        total="${parentSuccessorSubscription.getDerivedSubscribers().size() ?: 0}"/>
