            ...
            <table class="ui celled sortable table la-js-responsive-table la-table" id="parentSubscription">
                ...
                <g:each in="${participantsList}" var="participant" status="i">
                    ...
                    <tr class="">
                        <g:if test="${editable}">
                            <td>
                            <g:if test="${editable && participant.surveyVendors && VendorRole.countByVendorInListAndSubscription(participant.surveyVendors, newSub) < participant.surveyVendors.size()}">
