...
<%
    ...
    String icon_blue   = '<i class="' + Icon.X.CIRCLE + ' blue"></i>'
    String icon_green  = '<i class="' + Icon.X.CIRCLE + ' green"></i>'
    String icon_yellow = '<i class="' + Icon.X.CIRCLE + ' yellow"></i>'
    String icon_pink   = '<i class="' + Icon.X.CIRCLE + ' pink"></i>'
    String icon_teal   = '<i class="' + Icon.X.CIRCLE + ' teal"></i>'
    ...
    Closure hh_no_x = { de, en ->
        if (lang == 'de') {
            println """<p> ${de[0]} ohne ${de[1]} werden in der Gruppe <i class="${Icon.X.CIRCLE} pink"></i><strong>* ohne ${de[2]}</strong> zusammmen gefasst. </p>"""
        } else {
            println """<p> ${en[0]} without ${en[1]} are summarized in the group <i class="${Icon.X.CIRCLE} pink"></i><strong>* no ${en[2]}</strong>. </p>"""
        }
    }
...
<ui:infoModal id="${modalID}">
    ...
    <div class="help-section" data-help-section="subscription-x-provider">
        ...
        <g:if test="${lang == 'de'}">
            ...
            <p>
                ...
                <i class="${Icon.X.CIRCLE} blue"></i> Die Lizenz verweist direkt auf den Anbieter, <br />
                <i class="${Icon.X.CIRCLE} green"></i> Der Anbieter kann über ein referenziertes Paket ermittelt werden <br />
            </p>
        </g:if>
        <g:else>
            <p>
            ...
            <p>
                ...
                <i class="${Icon.X.CIRCLE} blue"></i> The subscription refers directly to the provider, <br />
                <i class="${Icon.X.CIRCLE} green"></i> The provider can be identified via a referenced package <br />
            </p>
        </g:else>
    ...
    <div class="help-section" data-help-section="subscription-x-memberProvider">
        ...
        <g:if test="${lang == 'de'}">
            ...
            <p>
                Einrichtungslizenzen ohne ausgewiesenen Anbieter oder ohne passende Übereinstimmung werden in der Gruppe <i class="${Icon.X.CIRCLE} pink"></i><strong>* keine Übereinstimmung</strong> zusammmen gefasst.
            </p>
        </g:if>
        <g:else>
            <p>
            ...
            <p>
                Participant subscriptions without a designated provider or without a suitable match are grouped together in the <i class="${Icon.X.CIRCLE} pink"></i><strong>* no Match</strong>.
            </p>
        </g:else>
    </div>
    ...
    <div class="help-section" data-help-section="subscription-x-platform">
        ...
        <g:if test="${lang == 'de'}">
            ...
            <p>
                Dabei sind folgende Varianten möglich: <br />
                <i class="${Icon.X.CIRCLE} blue"></i> Die Plattform kann direkt über eine Referenz aus dem Lizenz-Bestand ermittelt werden, <br />
                <i class="${Icon.X.CIRCLE} green"></i> Der einer Lizenz zugeordnete Anbieter verweist auf eine Plattform <br />
            </p>
        </g:if>
        <g:else>
            <p>
            ...
            <p>
                The following variants are possible: <br />
                <i class="${Icon.X.CIRCLE} blue"></i> The platform can be determined directly by a reference from the subscription entitlements, <br />
                <i class="${Icon.X.CIRCLE} green"></i> The provider assigned to a subscription refers to a platform <br />
            </p>
        </g:else>
    ...
    <div class="help-section" data-help-section="subscription-x-vendor">
        ...
        <g:if test="${lang == 'de'}">
            ...
            <p>
                Dabei sind folgende Varianten möglich: <br />
                <i class="${Icon.X.CIRCLE} blue"></i> Die Lizenz verweist direkt auf den Lieferanten, <br />
                <i class="${Icon.X.CIRCLE} green"></i> Der Lieferant kann über ein referenziertes Paket ermittelt werden <br />
            </p>
        </g:if>
        <g:else>
            <p>
            ...
            <p>
                The following variants are possible: <br />
                <i class="${Icon.X.CIRCLE} blue"></i> The subscription refers directly to the vendor, <br />
                <i class="${Icon.X.CIRCLE} green"></i> The vendor can be identified via a referenced package <br />
            </p>
        </g:else>
    ...
    <div class="help-section" data-help-section="platform-x-propertyWekb">
        ...
        <g:if test="${lang == 'de'}">
            ...
            <p>
                Pakete ohne entsprechende Merkmale werden in der Gruppe <i class="${Icon.X.CIRCLE} pink"></i><strong>* keine Angabe</strong> zusammmen gefasst. <br />
                Ohne <strong>we:kb</strong>-Pendant fehlen relevante Daten - solche Pakete werden unter <i class="${Icon.X.CIRCLE} teal"></i><strong>* kein web:kb Objekt</strong> gelistet. <br />
            </p>
        </g:if>
        <g:else>
            <p>
            ...
            <p>
                Packages without corresponding properties are summarized in the group <i class="${Icon.X.CIRCLE} pink"></i><strong>* no Information</strong>. <br />
                Relevant data is missing without a <strong>we:kb</strong> counterpart - such packages are listed under <i class="${Icon.X.CIRCLE} teal"></i><strong>* no web:kb object</strong>. <br />
            </p>
        </g:else>
    </div>
