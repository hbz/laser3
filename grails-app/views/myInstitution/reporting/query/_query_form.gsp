...
<div class="ui segment form">
    ...
    <div class="fields <uiReporting:numberToString number="${2 + cfgDistributionList.size()}"/>">
        ...
        <div class="field" style="text-align: right">
            ...
            <button id="query-export-button" class="ui icon button la-modern-button" data-href="#queryExportModal" data-ui="modal" disabled><i class="${Icon.CMD.DOWNLOAD}"></i></button>
            <button id="query-help-button" class="ui icon button la-modern-button" data-href="#queryHelpModal" data-ui="modal" disabled><i class="${Icon.UI.HELP}"></i></button>
        </div>
    </div>
</div>
