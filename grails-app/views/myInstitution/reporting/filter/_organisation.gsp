<%@page import="de.laser.reporting.myInstitution.OrganisationConfig;de.laser.ReportingService;de.laser.Org;de.laser.Subscription;de.laser.reporting.myInstitution.base.BaseConfig" %>
    ...
    <g:form action="reporting" method="POST" class="ui form">
        ...
        <div class="ui bottom attached active tab segment" data-tab="org-filter-tab-1">
            <div class="field">
                ...
                <g:set var="config" value="${OrganisationConfig.getCurrentConfig().base}" />
