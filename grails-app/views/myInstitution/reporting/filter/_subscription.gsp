<%@page import="de.laser.helper.Icons; de.laser.ReportingGlobalService;de.laser.Org;de.laser.Subscription;de.laser.reporting.report.myInstitution.base.BaseConfig" %>
...
%{--            </g:if>--}%
            ...
            <g:if test="${BaseConfig.getCurrentConfig( BaseConfig.KEY_SUBSCRIPTION ).memberSubscription}">
                <a class="item" data-tab="sub-filter-tab-help"> ? %{--<i class="${Icons.HELP}"></i>--}%</a>
            </g:if>
        </div><!-- .menu -->
