...
%{--                <ui:actionsDropdownItem data-ui="modal" href="#propDefGroupBindings" message="menu.institutions.configure_prop_groups" />--}%%{-- --}%%{-- erms-4798 --}%
        ...
        <sec:ifAnyGranted roles="ROLE_ADMIN">
            <g:if test="${actionName in ['show']}">
                ...
                <g:link class="item js-open-confirm-modal la-popup-tooltip ${org.isDeprecated() ? 'disabled' : ''}" action="markAsDeprecated" id="${params.id}"
                        data-confirm-tokenMsg="${message(code: "confirm.dialog.disable.org")}" data-confirm-term-how="ok">
                    <i class="exclamation triangle icon"></i> ${message(code:'org.markAsDeprecated.label')}
                </g:link>
