...
<g:if test="${accessService.checkConstraint_INST_EDITOR_PERM_X_RA( CustomerTypeService.PERMS_INST_PRO_CONSORTIUM_BASIC )}">
    <ui:actionsDropdown>
...
<g:elseif test="${accessService.checkConstraint_INST_EDITOR_PERM_X_RA( CustomerTypeService.ORG_INST_BASIC )}">
