...
<laser:htmlStart message="org.nav.options" serviceInjection="true" />
        ...
        <ui:tabs actionName="settings">
            ...
            <g:if test="${accessService.checkCtxPerm_or_ROLEADMIN( 'FAKE,ORG_INST_PRO,ORG_CONSORTIUM_BASIC' )}">
            ...
            <g:if test="${accessService.checkCtxPerm_or_ROLEADMIN( CustomerTypeService.PERMS_INST_PRO_CONSORTIUM_BASIC )}">
