...
<laser:htmlStart message="org.nav.options" serviceInjection="true" />
        ...
        <ui:tabs actionName="settings">
            ...
            <g:if test="${accessService.is_ROLE_ADMIN_or_has_PERMS( 'FAKE,ORG_INST_PRO,ORG_CONSORTIUM_BASIC' )}">
            ...
            <g:if test="${accessService.is_ROLE_ADMIN_or_has_PERMS( CustomerTypeService.PERMS_INST_PRO_CONSORTIUM_BASIC )}">
