<laser:htmlStart message="menu.public.all_insts" serviceInjection="true"/>
    ...
    <ui:controlButtons>
        ...
        <%
            editable = (editable && accessService.checkPerm('ORG_PRO,ORG_CONSORTIUM_BASIC')) || contextService.getUser()?.hasRole('ROLE_ADMIN') || accessService.checkConstraint_ORG_COM_EDITOR()
        %>
        <g:if test="${editable}">
