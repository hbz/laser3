...
<laser:htmlStart message="menu.public.all_insts" serviceInjection="true"/>
    ...
    <ui:controlButtons>
        ...
        <%
            editable = (editable && accessService.checkPerm(CustomerTypeService.PERMS_INST_PRO_CONSORTIUM_BASIC)) || contextService.getUser()?.hasRole('ROLE_ADMIN') || accessService.is_ORG_COM_EDITOR()
        %>
        <g:if test="${editable}">
