<%@ page import="de.laser.ui.Button; de.laser.ui.Icon; de.laser.Combo; de.laser.CustomerIdentifier; de.laser.storage.RDStore; de.laser.storage.RDConstants; de.laser.PersonRole; de.laser.Org; de.laser.RefdataValue; de.laser.RefdataCategory; de.laser.properties.PropertyDefinition; de.laser.properties.PropertyDefinitionGroup; de.laser.OrgSetting" %>
                ...
                <g:form controller="organisation" action="ids" class="ui small form" method="get">
                    ...
                    <div class="two fields">
                        ...
                        <div class="field la-field-right-aligned">
                            <a href="${createLink(controller:controllerName,action:actionName,params:[id:orgInstance.id,tab:'customerIdentifiers'])}" class="${Button.SECONDARY} reset">${message(code:'default.button.reset.label')}</a>
