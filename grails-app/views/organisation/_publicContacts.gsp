            ...
            <div class="description">
                ...
                <g:each in="${techSupports}" var="prs">
                    <laser:render template="/templates/cpa/person_full_details" model="${[
                            ...
                            personContext          : orgInstance,
                            tmplShowDeleteButton   : (isProviderOrAgency && (contextService.hasPermAsInstEditor_or_ROLEADMIN( CustomerTypeService.ORG_CONSORTIUM_BASIC ))),
                            tmplShowFunctions      : false,
                            tmplShowPositions      : true,
                            tmplShowResponsiblities: true,
                            showContacts           : true,
                            ...
                            action                 : 'show',
                            id                     : orgInstance.id,
                            editable               : (isProviderOrAgency && contextService.hasPermAsInstEditor_or_ROLEADMIN( CustomerTypeService.ORG_CONSORTIUM_BASIC ) && !existsWekbRecord),
                            noSelection            : true
                    ]}"/>
                </g:each>
