...
<g:if test="${accessService.checkMinUserOrgRole(user,institution,'INST_EDITOR')}">
    <ui:actionsDropdown>
        ...
        <g:if test="${contextCustomerType in ["ORG_INST","ORG_CONSORTIUM_BASIC","ORG_CONSORTIUM_PRO"]}">
        ...
        <g:if test="${editable}">
            ...
            <g:if test="${(contextCustomerType == "ORG_INST" && license._getCalculatedType() == License.TYPE_LOCAL) || (contextCustomerType in ['ORG_CONSORTIUM_BASIC', 'ORG_CONSORTIUM_PRO'] && license._getCalculatedType() == License.TYPE_CONSORTIAL)}">
            ...
            <g:if test="${(contextCustomerType == "ORG_INST" && !license.instanceOf) || contextCustomerType in ['ORG_CONSORTIUM_BASIC', 'ORG_CONSORTIUM_PRO']}">
        ...
        <g:if test="${actionName == 'show'}">
            ...
            <g:if test="${accessService.checkPermAffiliation('ORG_INST, ORG_CONSORTIUM_BASIC','INST_EDITOR') && !(institution.id == license.getLicensingConsortium()?.id && license.instanceOf)}">
                <div class="divider"></div>
...
<g:if test="${editable || accessService.checkPermAffiliation('ORG_INST,ORG_CONSORTIUM_BASIC','INST_EDITOR')}">
