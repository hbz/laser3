...
<ui:subNav actionName="${actionName}">
    ...
    <ui:securedSubNavItem orgPerm="ORG_PRO,ORG_CONSORTIUM_BASIC" controller="license" action="tasks" params="${[id:params.id]}" counts="${tasksCount}" message="task.plural" />
    <ui:securedSubNavItem orgPerm="ORG_PRO,ORG_CONSORTIUM_BASIC" controller="license" action="documents" params="${[id:params.id]}" message="license.nav.docs" />
