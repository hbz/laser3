                                ...
                                <g:if test="${ Person.getPublicByOrgAndFunc(role.org, 'General contact person') || Person.getPublicByOrgAndObjectResp(role.org, license, 'Specific license editor')  }">
                                    <g:each in="${Person.getPublicByOrgAndFunc(role.org, 'General contact person')}" var="func">
                                        <tr>
                                            ...
                                            <td>
                                                <g:link controller="organisation" action="${(institution.isCustomerType_Consortium() || institution.getCustomerType() == 'ORG_PRO') ? 'addressbook' : 'show'}" params="[id: role.org.id]" absolute="true">${func}</g:link>
                                            </td>
                                            <td>
                                                <ul>
                                    ...
                                    <g:each in="${Person.getPublicByOrgAndObjectResp(role.org, license, 'Specific license editor')}" var="resp">
                                        <tr>
                                            ...
                                            <td>
                                                <g:link controller="organisation" action="${(institution.isCustomerType_Consortium() || institution.getCustomerType() == 'ORG_PRO') ? 'addressbook' : 'show'}" params="[id: role.org.id]" absolute="true">${resp}</g:link>
                                            </td>
                                            <td>
                                                <ul>
