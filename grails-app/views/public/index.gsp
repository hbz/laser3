<%@ page import="de.laser.helper.Icons; de.laser.system.SystemMessage; de.laser.utils.AppUtils" %>
<!doctype html>
    ...
    <!--Page Contents-->
        ...
        <nav class="ui inverted menu la-top-menu" aria-label="${message(code:'wcag.label.mainMenu')}">
            <div class="ui container">
                ...
                <a class="item" href="${message(code:'url.wekb.' + currentServer)}" target="_blank"><i class="${Icons.LNK.WEKB}"></i> we:kb</a>
