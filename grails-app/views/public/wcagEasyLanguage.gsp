<%@ page import="de.laser.ui.Icon; de.laser.PersonRole; de.laser.addressbook.Contact; de.laser.OrgRole; de.laser.RefdataCategory;de.laser.RefdataValue;de.laser.properties.PropertyDefinition" %>
<laser:htmlStart message="wcagEasyLanguage" />
    ...
    <p>Mit dem Begriff Elektronische Ressourcen meint man: Sammlungen von Büchern und Zeitschriften, die nicht gedruckt werden, sondern die man digital am Computer benutzen kann. Viele Verlage bieten solche Sammlungen als Produkte an, die Bibliotheken für einen bestimmten Zeitraum kaufen können.
    In LAS:eR können Bibliotheken sehen, welche Produkte sie für welches Jahr gekauft haben. Man kann in LAS:eR außerdem viele Informationen zu den Produkten sehen, z.B. Preise und wie man die Produkte nutzen darf.
    </p>

    <h2 class="ui header">GASCO-Monitor in LAS:eR</h2>
    ...
    <h2 class="ui header">Übersichtliche Verwaltung in einem System</h2>
    <p>
    ...
    <h2 class="ui header">Statistiken für die Nutzung von Produkten</h2>
    <p>
    ...
    <h2 class="ui header">Gemeinsam leichter arbeiten</h2>
    <p>
