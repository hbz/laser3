    ...
    <ui:modal id="linkToSubModal" contentClass="scrolling" message="package.show.linkToSub" msgSave="${message(code: 'default.button.link.label')}">
        ...
        <g:form class="ui form" url="[controller: 'package', action: 'processLinkToSub', id: params.id]">
            ...
            <div class="field holdingSelection">
                <label for="holdingSelection">${message(code: 'subscription.holdingSelection.label')} <span class="la-long-tooltip la-popup-tooltip la-delay" data-content="${message(code: "subscription.holdingSelection.explanation")}"><i class="${Icons.HELP_TOOLTIP} icon la-popup"></i></span></label>
            </div>
