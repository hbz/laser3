...
%{--    <ui:securedSubNavItem orgPerm="ORG_INST,ORG_CONSORTIUM_BASIC" controller="package" action="tasks" params="${[id:params.id]}" message="task.plural" />

    <ui:securedSubNavItem orgPerm="ORG_INST,ORG_CONSORTIUM_BASIC" controller="package" action="documents" params="${[id:params.id]}" message="package.show.nav.docs" />
