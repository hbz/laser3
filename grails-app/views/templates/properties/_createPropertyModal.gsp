...
<ui:modal id="createPropertyModal" text="${message(code: 'default.add.label', args: [message(code: 'propertyDefinition.plural')])}" msgSave="${message(code: 'default.add.label', args: [message(code: 'propertyDefinition.plural')])}" modalSize="large">
