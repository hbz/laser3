<%@page import="de.laser.helper.Icons; de.laser.properties.SubscriptionProperty; de.laser.Subscription; de.laser.License; de.laser.AuditConfig; de.laser.properties.PropertyDefinition; de.laser.properties.PropertyDefinitionGroup; de.laser.properties.PropertyDefinitionGroupBinding" %>
                            ...
                            <tr>
                                <td>
                                    ...
                                    %{--<g:if test="${prop.type.multipleOccurrence}">
                                        <span class="${Icons.PROP.MULTIPLE}"> M </span>
                                    </g:if>--}%
                                </td>
                                <td>
