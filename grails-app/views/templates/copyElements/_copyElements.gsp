...
<ui:greySegment>
    ...
    <g:form action="${actionName}" controller="${controllerName}" id="${params.id}" data-confirm-id="copyElements_form"
        ...
        <table class="ui celled table la-js-responsive-table la-table">
            ...
            <g:if test="${copyObject && accessService.checkPerm("ORG_CONSORTIUM_BASIC") && sourceObject.hasProperty("instanceOf") && sourceObject instanceof Subscription}">
                <tr>
                    <td>
                        <div>
            ...
            <g:if test="${copyObject && accessService.checkPerm("ORG_CONSORTIUM_BASIC") && sourceObject.hasProperty("instanceOf") && sourceObject instanceof License}">
                <tr>
                    <td>
                        <div>
