<%@ page import="de.laser.ui.Button; de.laser.ui.Icon; de.laser.storage.RDStore; de.laser.Subscription; de.laser.Platform; de.laser.base.AbstractReport; de.laser.finance.CostItem" %>
    ...
    <g:if test="${reportTypes}">
        ...
        <g:form controller="subscription" action="generateReport" name="stats" class="ui form" method="get">
            ...
            <div class="field la-field-right-aligned">
                <input id="generateReport" type="button" class="${Button.PRIMARY}" disabled="disabled"
                ...
                <g:if test="${CostItem.findBySubAndCostItemElementConfiguration(subscription, RDStore.CIEC_POSITIVE)}">
                    <input id="generateCostPerUse" type="button" class="${Button.PRIMARY}" disabled="disabled"
                ...
                <g:link controller="$controllerName" action="$actionName" id="${params.id}" params="${parame}"
                        class="${Button.SECONDARY}">${message(code: 'default.button.reset.label')}</g:link>
            </div>
        </g:form>
