    ...
    <g:form class="ui form" url="${formUrl}" method="POST">
        ...
        <div class="ui grid">
            ...
            <div class="six wide column field">
                ...
                <ui:select class="ui search dropdown la-full-width" id="cie" name="cie" from="${costItemElements}" optionKey="id" optionValue="value"/>
            </div>
            <div class="four wide column field">
                <label for="sign">${message(code:'financials.costItemConfiguration')}</label>
                <ui:select class="ui search dropdown la-full-width" id="sign" name="sign" from="${elementSigns}" optionKey="id" optionValue="value" value="${signPreset}"/>
            </div>
            <div class="six wide column field">
