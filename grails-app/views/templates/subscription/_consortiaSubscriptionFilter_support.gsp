<%@ page import="de.laser.ui.Button; de.laser.helper.Params; de.laser.RefdataValue; de.laser.RefdataCategory; de.laser.storage.RDStore;de.laser.storage.RDConstants;de.laser.Org;de.laser.OrgRole;de.laser.properties.PropertyDefinition;de.laser.Subscription;de.laser.finance.CostItem" %>
...
<ui:filter>
    <g:form action="${actionName}" controller="${controllerName}" method="get" class="ui small form">
        ...
        <div class="field la-field-right-aligned">
            ...
            <a href="${returnURL}" class="${Button.SECONDARY} reset">${message(code:'default.button.reset.label')}</a>
