...
<%
    ...
    switch(ownobj.class.name) {
        case Org.class.name: documentMessage = "menu.my.documents"
            editable = userService.checkMinUserOrgRole_and_CtxOrg_or_ROLEADMIN(contextService.getUser(), contextOrg, 'INST_EDITOR')
            break
                ...
                <div class="ui small feed content la-js-dont-hide-this-card">
                    <div class="ui grid summary">
                        ...
                        <div class="right aligned eight wide column la-column-left-lessPadding">
                            ...
                            <%-- 3 --%>
                            <g:if test="${!(ownobj instanceof Org) && ownobj?.showUIShareButton() && userService.checkMinUserOrgRole_and_CtxOrg(contextService.getUser(), docctx.owner.owner, 'INST_EDITOR')}">
