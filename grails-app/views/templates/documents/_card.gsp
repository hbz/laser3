...
<%
    ...
    boolean editable2 = accessService.checkCtxPermAffiliation(CustomerTypeService.PERMS_INST_PRO_CONSORTIUM_BASIC, 'INST_EDITOR')
                ...
                <div class="ui small feed content la-js-dont-hide-this-card">
                    <div class="ui grid summary">
                        ...
                        <div class="right aligned eight wide column la-column-left-lessPadding">
                            ...
                            <%-- 3 --%>
                            <g:if test="${!(ownobj instanceof Org) && ownobj?.showUIShareButton() && accessService.checkMinUserOrgRole_and_CtxOrg(contextService.getUser(), docctx.owner.owner, 'INST_EDITOR')}">
