...
%{--                        </g:if>--}%
                        ...
                        <td class="x">
                            <g:if test="${docctx.isDocAFile()}">
                                ...
                                <g:if test="${userService.checkMinUserOrgRole_and_CtxOrg(user, docctx.owner.owner, 'INST_EDITOR') && inOwnerOrg && !docctx.sharedFrom}">
                                ...
                                <g:if test="${!docctx.sharedFrom && !docctx.isShared && userService.checkMinUserOrgRole_and_CtxOrg(user, docctx.owner.owner, 'INST_EDITOR') && inOwnerOrg}">
