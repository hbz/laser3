...
%{--                        </g:if>--}%
                        ...
                        <td class="x">
                            <g:if test="${docctx.isDocAFile()}">
                                ...
                                <g:if test="${accessService.checkMinUserOrgRole_ctxConstraint(user, docctx.owner.owner, 'INST_EDITOR') && inOwnerOrg && !docctx.sharedFrom}">
                                ...
                                <g:if test="${!docctx.sharedFrom && !docctx.isShared && accessService.checkMinUserOrgRole_ctxConstraint(user, docctx.owner.owner, 'INST_EDITOR') && inOwnerOrg}">
