...
<g:if test="${controllerName == 'survey' && actionName == 'show'}">
    ...
    <table class="ui celled sortable table la-js-responsive-table la-table">
        ...
        <tr>
            ...
            <g:if test="${editable && surveyInfo.status == RDStore.SURVEY_IN_PROCESSING && properties}">
        ...
        <tbody>
        <g:each in="${properties}" var="surveyPropertyConfig" status="i">
            <tr>
    ...
    <table class="ui celled sortable table la-js-responsive-table la-table">
        ...
        <g:each in="${properties}" var="surveyResult" status="i">
