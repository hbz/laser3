<%@ page import="de.laser.SurveyLinks; de.laser.SurveyConfig; de.laser.DocContext; de.laser.RefdataValue; de.laser.finance.CostItem; de.laser.properties.PropertyDefinition; de.laser.SurveyOrg; de.laser.SurveyConfigProperties; de.laser.Subscription; de.laser.helper.RDStore; de.laser.helper.RDConstants; de.laser.RefdataCategory" %>
                            ...
                            <g:each in="${surveyLinks}" var="surveyLink">
                                ...
                                <g:if test="${surveyLink.targetSurvey.status != RDStore.SURVEY_IN_PROCESSING}">
                                    <g:if test="${SurveyOrg.findAllByOrgAndSurveyConfigInList(institution, surveyLink.targetSurvey.surveyConfigs).size() > 0}">
                                        <tr>
                                            <td><g:link controller="myInstitution" action="surveyInfos"
                                    ...
                                    <g:else>
                                        ...
                                        <g:if test="${!existsMultiYearTerm}">
                                            <tr>
                                                <td>${surveyLink.targetSurvey.name}
