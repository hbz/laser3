...
<g:each in="${checklists}" var="clist">
    ...
    <div data-wfId="${clist.id}" class="workflow-details" style="margin-top:50px;overflow:scroll">
                ...
                <div class="ui grid">
                    <div class="row">
                        ...
                        <div class="one wide column wf-centered">
                            ...
                            <g:if test="${workflowOldService.hasUserPerm_wrench()}"><!-- TODO: workflows-permissions -->
