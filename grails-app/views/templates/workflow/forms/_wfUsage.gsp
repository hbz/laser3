<%@ page import="de.laser.storage.RDStore; de.laser.Subscription; de.laser.workflow.WorkflowHelper; de.laser.helper.DateUtils; de.laser.storage.RDConstants; de.laser.RefdataCategory; de.laser.RefdataValue; de.laser.workflow.*;" %>
                        ...
                        <g:elseif test="${field.startsWith('date')}">
                            <div class="field">
                                ...
                                <input type="date" name="${prefixOverride}_${field}" id="${prefixOverride}_${field}"
                                    <% print task.condition.getProperty(field) ? 'value="' + DateUtils.getFixedSDF_yyyyMMdd().format(task.condition.getProperty(field)) + '"' : '' %>
                                />
                            </div>
                        </g:elseif>
