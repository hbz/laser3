<%@ page import="de.laser.storage.RDStore; de.laser.helper.WorkflowHelper; de.laser.helper.DateUtils; de.laser.storage.RDConstants; de.laser.RefdataCategory; de.laser.RefdataValue; de.laser.workflow.*;" %>
                    ...
                    <g:if test="${field.startsWith('date')}">
                        <div class="field">
                            ...
                            <input type="date" name="${prefix}_${field}" id="${prefix}_${field}"
                                <% print condition.getProperty(field) ? 'value="' + DateUtils.getFixedSDF_yyyyMMdd().format(condition.getProperty(field)) + '"' : '' %>
                            />
                        </div>
                    </g:if>
                    <g:if test="${field.startsWith('file')}">
