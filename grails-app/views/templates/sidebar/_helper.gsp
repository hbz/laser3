...
<g:if test="${tmplConfig && tmplConfig.addActionDropdownItems}">
    ...
    <g:if test="${contextService.isInstEditor_or_ROLEADMIN(CustomerTypeService.PERMS_PRO_SUPPORT)}">
    ...
    <g:if test="${contextService.isInstEditor_or_ROLEADMIN(CustomerTypeService.PERMS_PRO_SUPPORT)}"><!-- TODO: workflows-permissions -->
