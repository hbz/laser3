<%@ page import="de.laser.ui.Button; de.laser.ui.Icon; de.laser.Org; de.laser.OrgSetting; de.laser.RefdataCategory; groovy.json.JsonOutput; de.laser.api.v0.ApiToolkit; de.laser.api.v0.ApiManager; de.laser.auth.Role; de.laser.storage.RDStore; de.laser.storage.RDConstants; de.laser.PersonRole; de.laser.Contact; de.laser.OrgRole; de.laser.RefdataValue" %>
...
%{--                        <ui:customerTypeIcon org="${org}" />--}%
                    ...
                    <td class="x">
                        <g:if test="${org.isCustomerType_Consortium() || org.isCustomerType_Support()}">
                            <button type="button" class="${Button.MODERN.BASIC_ICON} la-popup-tooltip la-delay"
