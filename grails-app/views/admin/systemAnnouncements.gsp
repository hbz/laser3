        ...
        <g:each in="${announcements}" var="sa">
            <div class="ui segment">
                ...
                <g:if test="${sa.isPublished}">
                    <div class="ui green ribbon label"><i class="icon exclamation circle"></i>${message(code:'announcement.published')}</div>
                </g:if>
                ...
                <div>
                    ...
                    <g:else>
                        ...
                        <g:link controller="admin" action="systemAnnouncements" id="${sa.id}" params="[cmd:'edit']" role="button" class="ui icon button la-modern-button"><i aria-hidden="true" class="${Icons.CMD_EDIT}"></i></g:link>
