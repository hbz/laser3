...
<laser:htmlStart message="menu.admin.manageRefdatas" />
        ...
        <ui:messages data="${flash}" />
            ...
            <div class="content ui form">
                <div class="fields">
                    <div class="field">
                        <button class="${Btn.BASIC}" value="" data-href="#addRefdataValueModal" data-ui="modal">${message(code:'refdataValue.create_new.label')}</button>
                    </div>
                    <div class="field">
                        <button class="${Btn.BASIC}" value="" data-href="#addRefdataCategoryModal" data-ui="modal">${message(code:'refdataCategory.create_new.label')}</button>
                    </div>
                    <div class="field">
                        <g:link class="${Btn.BASIC}" action="manageRefdataIntegrityCheck"><i class="icon wrench"></i> ${message(code:'default.integrityCheck.label')}</g:link>
                    </div>
                </div>
            </div>
                                        ...
                                        <sec:ifAnyGranted roles="ROLE_YODA">
                                            <g:if test="${usedRdvList?.contains(rdv.id)}">
                                                <span data-position="top rightla-popup-tooltip la-delay" data-content="${message(code:'refdataValue.exchange.label')}">
                                                    <button class="${Btn.MODERN.BASIC_ICON}" data-href="#replaceRefdataValueModal" data-ui="modal"
