...
<div class="container">
    <g:form method="get" autocomplete="off">
        ...
        <div class="field">
            ...
            <!--<div class="control">
                <button class="button is-medium button is-info">find them all
                </button>
            </div>-->
        </div>
                    ...
                    <td>
                        ...
                        <g:each in="${sub.packages}" var="subPkg" status="j">
                            <div class="la-flexbox">
                                ...
                                <span class="tag is-warning is-light">Details</span>
                                    ...
                                    <div class="content">
                                        ...
                                        <g:each in ="${Contact.findAllByPrsAndContentType(
                                            ...
                                            <div class="description">
                                                ...
                                                <span class="tag is-success is-light">URL</span>
                                        ...
                                        <g:each in ="${Contact.findAllByPrsAndContentType(
                                            ...
                                            <div class="description js-copyTriggerParent">
                                                ...
                                                <span class="tag is-success is-light">Mail</span>
