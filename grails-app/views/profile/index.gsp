                        ...
                        <table class="ui celled la-js-responsive-table la-table compact table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>${contextService.getOrg().isCustomerTypeConsortium() ? message(code: 'profile.notification.for.SurveysParticipationFinish') : message(code: 'profile.notification.for.SurveysParticipationFinish2')}</td>
                                </tr>
