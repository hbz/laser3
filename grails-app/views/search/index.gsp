                        ...
                        <tr>
                            ...
                            <g:if test="${object.rectype == 'Subscription'}">
                                ...
                                <td>
                                    ...
                                    <br />
                                    <g:if test="${object.membersCount && contextOrg.getCustomerType()  in ['ORG_CONSORTIUM_BASIC', 'ORG_CONSORTIUM_PRO']}">
                                        <strong>${message(code: 'subscription.details.consortiaMembers.label')}</strong>:
                                        <g:link controller="subscription" action="members"
                                                id="${object.dbId}">${object.membersCount}</g:link>
                                    </g:if>
                                    <g:if test="${object.members && contextOrg.getCustomerType()  in ['ORG_CONSORTIUM_BASIC', 'ORG_CONSORTIUM_PRO']}">
                                        <strong>${message(code: 'subscription.details.consortiaMembers.label')}</strong>:
                                    ...
                                    <br />
                                    <g:if test="${RDStore.SUBSCRIPTION_TYPE_CONSORTIAL.value in object.type?.value && !(contextOrg.getCustomerType()  in ['ORG_CONSORTIUM_BASIC', 'ORG_CONSORTIUM_PRO'])}">
