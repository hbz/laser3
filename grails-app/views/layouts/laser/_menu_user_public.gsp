...
<div class="ui dropdown item" role="menuitem" aria-haspopup="true">
    ...
    <div class="menu" role="menu">
        ...
        <a href="${message(code:'url.wekb.' + currentServer)}" id="wekb" class="item" role="menuitem" target="_blank" onclick="JSPC.app.workaround_targetBlank(event)"><i class="${Icons.WEKB}"></i> we:kb</a>
    </div>
</div>
