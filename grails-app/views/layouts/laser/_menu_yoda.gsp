...
%{--                    <div class="menu" role="menu">--}%
                        ...
                        <ui:link addItemAttributes="true" controller="yoda" action="updateData" params="[dataToLoad:'laserID', objType:'issueEntitlement']" onclick="return confirm('${message(code:'confirm.start.reload')}')">${message(code:'menu.yoda.updateLaserID')}</ui:link>
