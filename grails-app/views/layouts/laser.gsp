                        ...
                        <div class="ui dropdown item" role="menuitem" aria-haspopup="true">
                            ...
                            <div class="menu" role="menu">
                                ...
                                <div class="item" role="menuitem" aria-haspopup="true">
                                    ...
                                    <i  class="dropdown icon"></i>
                                    <div class="menu" role="menu">
                                        <semui:link class="item" role="menuitem" controller="yoda" action="esIndexUpdate" onclick="return confirm('${message(code:'confirm.start.ESUpdateIndex')}')">${message(code:'menu.yoda.updateESIndex')}</semui:link>
