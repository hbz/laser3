                    ...
                    <g:if test="${contextOrg}">
                        ...
                        <div class="ui dropdown item" role="menuitem" aria-haspopup="true">
                            ...
                            <div class="menu" role="menu">
                                ...
                                <ui:securedMainNavItem generateElementId="true" role="menuitem" orgPerm="ORG_PRO,ORG_CONSORTIUM_BASIC" affiliation="INST_USER" controller="myInstitution" action="documents" message="menu.my.documents" />

                                <div class="divider"></div>

                                <ui:securedMainNavItem generateElementId="true" role="menuitem" orgPerm="ORG_PRO,ORG_CONSORTIUM_BASIC" affiliation="INST_USER" controller="myInstitution" action="subscriptionsManagement" message="menu.my.subscriptionsManagement" />
                                ...
                                <div class="divider"></div>
                                <ui:securedMainNavItem generateElementId="true" role="menuitem" orgPerm="ORG_PRO,ORG_CONSORTIUM_BASIC" affiliation="INST_USER" controller="compare" action="compareSubscriptions" message="menu.my.comp_sub" />
                                <ui:securedMainNavItem generateElementId="true" role="menuitem" orgPerm="ORG_PRO,ORG_CONSORTIUM_BASIC" affiliation="INST_USER" controller="compare" action="compareLicenses" message="menu.my.comp_lic" />
                            </div>
                        </div>
                        ...
                        <div class="ui dropdown item" role="menuitem" aria-haspopup="true">
                            ...
                            <div class="menu" role="menu">
                                ...
                                <ui:securedMainNavItem generateElementId="true" role="menuitem" orgPerm="ORG_PRO,ORG_CONSORTIUM_BASIC" affiliation="INST_USER" controller="myInstitution" action="addressbook" message="menu.institutions.myAddressbook" />
                                <ui:securedMainNavItem generateElementId="true" role="menuitem" orgPerm="ORG_PRO,ORG_CONSORTIUM_BASIC" affiliation="INST_USER" controller="myInstitution" action="tasks" message="task.plural" />
                                <%--<ui:securedMainNavItem generateElementId="true" role="menuitem" orgPerm="ORG_PRO,ORG_CONSORTIUM_BASIC" affiliation="INST_USER" controller="myInstitution" action="changes" message="menu.institutions.changes" />--%>
                                <ui:securedMainNavItem generateElementId="true" role="menuitem" orgPerm="ORG_PRO,ORG_CONSORTIUM_BASIC" affiliation="INST_USER" controller="myInstitution" action="managePrivatePropertyDefinitions" message="menu.institutions.manage_props" />
                                ...
                                <ui:securedMainNavItem generateElementId="true" role="menuitem" orgPerm="ORG_PRO,ORG_CONSORTIUM_BASIC" affiliation="INST_USER" specRole="ROLE_ADMIN" controller="costConfiguration" action="index" message="menu.institutions.costConfiguration" />
                                <ui:securedMainNavItem generateElementId="true" role="menuitem" orgPerm="ORG_PRO,ORG_CONSORTIUM_BASIC" affiliation="INST_EDITOR" specRole="ROLE_ADMIN" controller="myInstitution" action="financeImport" message="menu.institutions.financeImport" />
                                <ui:securedMainNavItem generateElementId="true" role="menuitem" orgPerm="ORG_PRO,ORG_CONSORTIUM_BASIC" affiliation="INST_USER" specRole="ROLE_ADMIN" controller="myInstitution" action="budgetCodes" message="menu.institutions.budgetCodes" />
...
%{--    </nav>--}%
            ...
            <div class="ui container">
                ...
                <div class="right menu la-advanced-view">
                    <div class="item">
                        ...
                        <g:if test="${(controllerName=='dev' && actionName=='frontend' ) || (controllerName=='subscription'|| controllerName=='license') && actionName=='show' && (editable || accessService.checkPermAffiliationX('ORG_PRO,ORG_CONSORTIUM_BASIC','INST_EDITOR','ROLE_ADMIN'))}">
                            <div class="item">
    ...
    %{-- global content container --}%
        ...
        <g:if test="${(controllerName=='dev' && actionName=='frontend' ) || (controllerName=='subscription'|| controllerName=='license') && actionName=='show'}">
            <laser:script file="${this.getGroovyPageFileName()}">
                <g:if test="${editable} || ${accessService.checkPermAffiliationX('ORG_PRO,ORG_CONSORTIUM_BASIC','INST_EDITOR','ROLE_ADMIN')}">
                    <g:if test="${user?.getSettingsValue(UserSetting.KEYS.SHOW_EDIT_MODE, RefdataValue.getByValueAndCategory('Yes', RDConstants.Y_N))?.value == 'Yes'}">
