...
<body class="${controllerName}_${actionName}">
    ...
    <nav aria-label="${message(code:'wcag.label.mainMenu')}">
        <div id="mainMenue" class="ui fixed inverted  menu" role="menubar" >
    ...
    <div id="verticalMenue" class="ui inverted vertical accordion sidebar  menu la-js-verticalNavi" role="menubar" >
    ...
    %{-- global content container --}%
        ...
        <main id="la-js-mainContent" class="ui main noPusher pusher ${visibilityContextOrgMenu} hidden">
    <sec:ifAnyGranted roles="ROLE_USER">
        <g:set var="visibilityContextOrgMenu" value="la-show-context-orgMenu" />
        <nav class="ui stackable menu la-contextBar" aria-label="${message(code:'wcag.label.modeNavigation')}" >
