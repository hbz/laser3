<%@ page import="de.laser.config.ConfigMapper; de.laser.RefdataValue; de.laser.utils.DateUtils; de.laser.storage.RDConstants" %>
    ...
    <g:else>
        <h2 class="ui header">
            <g:message code="platform.stats.data.header"/> <g:link url="${platformInstanceRecord.wekbUrl}" target="_blank" class="la-popup-tooltip la-delay" data-content="we:kb Link"><i class="icon la-gokb"></i></g:link>
        </h2>
        <div class="ui grid">
