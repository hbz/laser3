    ...
    <div class="html ui top attached segment">
        ...
        <div class="field">
            <label for="filterPropDef">
                Merkmal
                <i aria-hidden="true" class="${Icons.HELP_TOOLTIP} la-popup"></i>
                <div class="ui popup">
                    <i aria-hidden="true" class="${Icons.PROPERTY_PRIVATE}"></i> = Mein Merkmal
                </div>
            </label>
...
<div class="dropdown example">
        ...
        <div class="field">
            ...
            <div class="ui search selection dropdown ">
                ...
                <div class="menu">
                    ...
                    <div class="item" data-value="3">AGB <i aria-hidden="true" class="${Icons.PROPERTY_PRIVATE}"></i></div>
                    <div class="item" data-value="4">Alternativname <i aria-hidden="true" class="${Icons.PROPERTY_PRIVATE}"></i></div>
                    <div class="item" data-value="5" >Archivzugriff</div>
                    <div class="item" data-value="6" >Bei hbz Aufnahme der Metadaten nachfragen <i aria-hidden="true" class="${Icons.PROPERTY_PRIVATE}"></i></div>
    ...
    <div class="ui instructive bottom attached segment">
        ...
        &lt;div class=&quot;ui  popup &quot;&gt;
        &lt;i class=&quot;${Icons.PROPERTY_PRIVATE} &quot;&gt;&lt;/i&gt; = Meine Merkmal
        &lt;/div&gt;
        &lt;/label&gt;
        ...
        &lt;div class=&quot;item&quot; data-value=&quot;linkurl&quot;&gt;AGB &lt;i class=&quot;${Icons.PROPERTY_PRIVATE} &quot;&gt;&lt;/i&gt;&lt;/div&gt;
        &lt;/div&gt;
        &lt;/div&gt;
        &lt;/div&gt;
        </pre>
