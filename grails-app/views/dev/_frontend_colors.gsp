...
.ui.segment.__color-box-segment .color-container .color-wrapper.__warning {
    background: #1B1C1D!important;
}
...
<div class="html ui top attached segment example">
            ...
            <div class="ui grid stackable equal width">
                <div class="row">
                    ...
                    <div class="column">
                        <div class="ui segment __color-box-segment">
                            <div class="color-container">
                                <div class="color-wrapper __primary-light"></div>
                            </div>
                            <div class="text-container">
                                <h5>PRIMARY-LIGHT</h5>
                            </div>
                    ...
                    <div class="column">
                        <div class="ui segment __color-box-segment">
                            <div class="color-container">
                                <div class="color-wrapper __secondary"></div>
                            </div>
                            <div class="text-container">
                                <h5>SECONDARY</h5>
                            </div>
    ...
    <div class="ui top attached label">Laser Color Palette</div>
