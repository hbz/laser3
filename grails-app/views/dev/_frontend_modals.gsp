...
<div class="html ui top attached segment example">
    ...
    <ui:modal id="modal1" refreshModal="true" message="package.show.linkToSub">
        <div class="ui top attached stackable tabular la-tab-with-js menu">
            ...
            <a class="item" data-tab="tab-1">Tab 2</a>
        </div>

        <div class="ui bottom attached tab segment" data-tab="tab-0">
            <p>
                Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet.
            </p>
        </div>

        <div class="ui bottom attached tab segment" data-tab="tab-1">
    ...
    <ul>
        <li>
            da die Inhalte dieser (meist Export-Sammler) Modale sehr lang sind, macht es mehr Sinn, das gesamte Modal insgesammt zu scrollen
        </li>

        <li>
            es kommt zu Problemen, wenn die Inhalte in manchen Tabs scrollbar sind und in anderen Tabs nicht. Dehalb muss dort die Klasse "longer" zum Modal hinzugefürgt werden. Dafür wird das Atrribut <strong>refreshModal="true"</strong> mit übergeben.
        </li>
        <li>
            über die Klasse <strong>longer</strong> wird mit Javascript ein refresh ausgeführt, sobald der andere Tab aufgerufen wird
        </li>
    </ul>
</div>
...
<div class="annotation transition visible">
    <div class="ui instructive bottom attached segment">
        <pre aria-hidden="true">
            <code data-lang="xml">
            &lt;ui:modal modalSize="large" id="&#36;{modalID}" text="Excel-Export" <strong>refreshModal="true"</strong> hideSubmitButton="true"&gt;
            .
            .
            .
            &lt;/ui:modal&gt;
...
<h4 class="ui header">Modal-Content soll scrollen</h4>
...
<div class="annotation transition visible">
    <div class="ui instructive bottom attached segment">
        <pre aria-hidden="true">
            <code data-lang="xml">
            &lt;ui:modal id="linkToSubModal" <strong>contentClass="scrolling"</strong> message="package.show.linkToSub" msgSave="&#36;{message(code: 'default.button.link.label')}"&gt;
            .
            .
            .
            &lt;/ui:modal&gt;
