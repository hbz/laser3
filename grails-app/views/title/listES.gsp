<%@ page import="de.laser.ui.Button; de.laser.ui.Icon; de.laser.RefdataValue;de.laser.storage.RDConstants" %>
        ...
        <div class="three fields">
          ...
          <div class="field">
            ...
            <div class="field la-field-right-aligned">
              ...
              <button class="${Button.PRIMARY}" type="submit" name="search" value="yes">${message(code: 'default.button.filter.label')}</button>
            </div>
        </div>
      </g:form>
    </ui:filter>
