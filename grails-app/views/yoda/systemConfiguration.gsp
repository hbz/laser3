...
<div id="cfgFilter">
    ...
    <span class="ui label" data-class="green"><i class="${Icons.X.SQUARE} green"></i>spring</span>
    <span class="ui label" data-class="orange"><i class="${Icons.X.SQUARE} orange"></i>grails</span>
    <span class="ui label" data-class="yellow"><i class="${Icons.X.SQUARE} yellow"></i>grails.plugin(s)</span>
    <span class="ui label" data-class="red"><i class="${Icons.X.SQUARE} red"></i>java</span>
    <span class="ui label" data-class="blue"><i class="${Icons.X.SQUARE} blue"></i>dataSource</span>
    <span class="ui label" data-class="native"><i class="${Icons.X.SQUARE} grey"></i>default</span>
</div>
