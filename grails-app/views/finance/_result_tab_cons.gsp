    ...
    <thead>
        <tr>
            ...
            <g:else>
                ...
                <g:if test="${accessService.checkPermAffiliation(CustomerTypeService.PERMS_INST_PRO_CONSORTIUM_BASIC, 'INST_EDITOR') && !params.orgBasicMemberView}">
                    <th class="la-action-info"><g:message code="default.actions.label"/></th>
                </g:if>
            </g:else>
        </tr>
            ...
            <g:each in="${data.costItems}" var="ci" status="jj">
                ...
                <tr id="bulkdelete-b${ci.id}">
                    ...
                    <g:if test="${!params.orgBasicMemberView}">
                        ...
                        <g:elseif test="${accessService.checkPermAffiliation(CustomerTypeService.ORG_INST_PRO, 'INST_EDITOR')}">
                            <td class="x">
                                <g:if test="${fixedSubscription}">
