    ...
    <thead>
        <tr>
            ...
            <g:if test="${!fixedSubscription}">
                ...
                <g:if test="${editable && accessService.checkPermAffiliation("ORG_CONSORTIUM_BASIC,ORG_PRO","INST_EDITOR")}">
            ...
            <g:else>
                ...
                <g:if test="${accessService.checkPermAffiliation("ORG_CONSORTIUM_BASIC,ORG_PRO","INST_EDITOR") && !params.orgBasicMemberView}">
                    <th class="la-action-info"><g:message code="default.actions.label"/></th>
                </g:if>
            </g:else>
        </tr>
