<!-- _filter.gsp -->
<%@ page import="de.laser.ui.Button; de.laser.ui.Icon; de.laser.utils.LocaleUtils; de.laser.utils.DateUtils; de.laser.RefdataValue; de.laser.I10nTranslation; java.text.SimpleDateFormat;de.laser.storage.RDStore;de.laser.storage.RDConstants;de.laser.properties.PropertyDefinition;de.laser.OrgRole;de.laser.RefdataCategory;de.laser.FinanceController;de.laser.finance.CostItem" %>
        ...
        <g:form url="${formUrl}" method="get" class="ui form">
            ...
            <div class="three fields">
                ...
                <div class="field la-field-right-aligned">
                    <a href="${request.forwardURI}?reset=true" class="${Button.SECONDARY} reset">${message(code:'default.button.reset.label')}</a>
                    <g:hiddenField name="showView" value="${showView}"/>
                    <input type="submit" name="submit" class="${Button.PRIMARY}" value="${message(code:'default.button.filter.label')}">
                </div>
            </div>
