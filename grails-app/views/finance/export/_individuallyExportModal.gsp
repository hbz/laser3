            ...
            <div class="fields">
                ...
                <div class="wide eight field">
                    ...
                    <input name="filename" id="filename"
                           value="${subscription ? (escapeService.escapeString(subscription.name) + "_" + message(code:'subscription.details.financials.label')) : message(code:'subscription.details.financials.label')}"/>
                </div>
