...
databaseChangeLog = {
    ...
    changeSet(author: "djebeniani (hand-coded)", id: "1681469132222-1") {
        grailsChange {
            change {
    ...
    changeSet(author: "djebeniani (hand-coded)", id: "1681469132222-2") {
        grailsChange {
            change {
    ...
    changeSet(author: "djebeniani (hand-coded)", id: "1681469132222-3") {
        grailsChange {
            change {
