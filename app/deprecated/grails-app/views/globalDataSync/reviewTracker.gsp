  ...
  <body>
    ...
    <g:form action="createTracker" controller="globalDataSync" id="${params.id}">
      ...
      <div class="ui segment">
        <h1 class="ui icon header la-clear-before la-noMargin-top"><semui:headerIcon /><g:message code="globalDataSync.reviewTracker"/></h1>
        <g:if test="${type=='new'}">
    ...
    <div class="ui segment">
      <h1 class="ui icon header la-clear-before la-noMargin-top"><semui:headerIcon /><g:message code="globalDataSync.packageSyncImpact" /></h1>
