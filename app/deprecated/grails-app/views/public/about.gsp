...
<head>
    ...
    <title>${message(code: 'public.about.label')} | ${message(code: 'laser')}</title>
</head>
...
<body class="public">
    ...
    <div class="ui container">
        <h1 class="ui icon header la-clear-before la-noMargin-top"><semui:headerIcon />${message(code: 'public.nav.about.label')}</h1>
