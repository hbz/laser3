...
<g:set var="costItemElement"  scope="request" value="${de.laser.RefdataValue.executeQuery('select ciec.costItemElement from CostItemElementConfiguration ciec where ciec.forOrganisation = :org',[org:org])}"/>
