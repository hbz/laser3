        ...
        if (params.identifier) {
            ...
            // identifier based
                ...
                base_qry += tmpBaseQuery1 + ", TitleInstance ti, TitleInstancePackagePlatform tipp, IssueEntitlement ie " +
                        " where io.ti = ti.id and tipp.title = ti.id and ie.tipp = tipp.id and ie.subscription = s.id " + tmpBaseQuery2  + " or "

                base_qry += tmpBaseQuery1 + ", OrgRole ro where io.org = ro.org and ro.sub = s " + tmpBaseQuery2
