        ...
        updateES(com.k_int.kbplus.License.class) { lic ->
            ...
            switch(lic.getCalculatedType()) {
                ...
                case CalculatedType.CALCULATED_TYPE_PARTICIPATION:
                    ...
                    break
                case CalculatedType.CALCULATED_TYPE_LOCAL:
            ...
            def result = [:]
                ...
                switch (sub.getCalculatedType()) {
                    ...
                    case CalculatedType.CALCULATED_TYPE_COLLECTIVE:
                        ...
                        break
                /*              case CalculatedType.CALCULATED_TYPE_ADMINISTRATIVE:
                                  result.availableToOrgs = sub.orgRelations.findAll {it.roleType.value in [RDStore.OR_SUBSCRIBER_CONS.value]}?.org?.id
                                  break*/
                    case CalculatedType.CALCULATED_TYPE_PARTICIPATION_AS_COLLECTIVE:
