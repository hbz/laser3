        ...
        <g:each in="${orgInstance.links}" var="ol">
          <li>
            ...
            <g:elseif test="${ol.sub?.id}">
              <g:link controller="subscription" action="show" id="${ol.sub.id}" >${ol.sub.name ?: ol.sub.id} (${message(code:'default.subscription.label')})</g:link>
            </g:elseif>
            ...
            <g:elseif test="${ol.title?.id}">
              <g:link controller="title" action="show" id="${ol.title.id}" >${ol.title.title ?: ol.title.id} (${message(code:'title.label')})</g:link>
            </g:elseif>
            <g:else>
              ${ol}
            </g:else>
