...
<html>
  ...
  <body>
    ...
    <div class="container">
		...
		<h6>${message(code:'person.private_properties')}</h6>
		<div id="custom_props_div" class="span12">
			<g:render template="/templates/properties/private" model="${[ prop_desc:PropertyDefinition.PRV_PRS_PROP,ownobj:personInstance ]}"/>
		</div>
...
${personInstance.privateProperties}
