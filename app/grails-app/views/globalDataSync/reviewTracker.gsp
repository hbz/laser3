...
<html>
  ...
  <body>
        ...
        <h1 class="ui left floated aligned icon header la-clear-before"><semui:headerIcon /><g:message code="globalDataSync.newTracker" args="[item.name,item.identifier,item.source.name]" /></h1>
    ...
    <g:form action="createTracker" controller="globalDataSync" id="${params.id}">
      ...
      <div class="ui segment">
        <h1 class="ui left floated aligned icon header la-clear-before"><semui:headerIcon /><g:message code="globalDataSync.reviewTracker"/></h1>
        <g:if test="${type=='new'}">
    ...
    <div class="ui segment">
      <h1 class="ui left floated aligned icon header la-clear-before"><semui:headerIcon /><g:message code="globalDataSync.packageSyncImpact" /></h1>
