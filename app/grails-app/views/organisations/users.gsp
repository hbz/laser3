          ...
          <tr>
            ...
            <td>
              ...
              <g:if test="${((userOrg[0].status==1 ) || (userOrg[0].status==3)) }">
                <g:link controller="organisations" action="revokeRole" params="${[grant:userOrg[0].id, id:params.id]}" class="btn">${message(code:'default.revoke.label', default:'Revoke')}</g:link>
              </g:if>
              <g:else>
                <g:link controller="organisations" action="enableRole" params="${[grant:userOrg[0].id, id:params.id]}" class="btn">${message(code:'default.allow.label', default:'Allow')}</g:link>
              </g:else>
