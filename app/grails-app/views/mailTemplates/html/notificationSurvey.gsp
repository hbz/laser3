...
<g:else>
    ...
    <g:else>
        <g:if test="${survey.type == de.laser.helper.RDStore.SURVEY_TYPE_INTEREST}">
        ...
        <g:elseif test="${survey.type == de.laser.helper.RDStore.SURVEY_TYPE_SUBSCRIPTION}">
        ...
        <g:elseif test="${survey.type == de.laser.helper.RDStore.SURVEY_TYPE_TITLE_SELECTION}">
