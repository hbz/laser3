<%@ page
        import="de.laser.UserSettings; de.laser.Person; de.laser.base.AbstractPropertyWithCalculatedLastUpdated; de.laser.helper.RDStore; de.laser.helper.SqlDateUtils; com.k_int.kbplus.*;" %><laser:serviceInjection /><%@ page Content-type: text/plain; charset=utf-8; %><g:set var="userName" value="${raw(user.username)}"/><g:set var="orgName" value="${raw(org.name)}"/><g:set var="language" value="${user.getSetting(UserSettings.KEYS.LANGUAGE_OF_EMAILS, RDStore.LANGUAGE_DE).value}"/><g:if test="${dueDates}">----------------------------------------------------------------------------------------------------------------------------------
