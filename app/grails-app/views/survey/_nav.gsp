...
<semui:subNav actionName="${actionName}">
    ...
    <g:if test="${!surveyConfig?.pickAndChoose}">
        ...
        <g:else>
            ...
            <semui:subNavItem controller="survey" disabled="${subNavDisable}" action="surveyCostItems"
                              params="${[id: params.id, surveyConfigID: surveyConfig?.id]}"
                              message="surveyCostItems.label"/>

            <semui:subNavItem controller="survey" disabled="${subNavDisable}" action="surveyEvaluation"
                              params="${[id: params.id, surveyConfigID: surveyConfig?.id]}"
