            ...
            <div class="ui two fields">
                <div class="field">
                    ...
                    <g:if test="${parentSuccessorSubscription.owner}">
                        <g:if test="${parentSuccessorSubscription.getCalculatedType() == CalculatedType.CALCULATED_TYPE_PARTICIPATION_AS_COLLECTIVE && institution.id == parentSuccessorSubscription.getCollective().id}">
