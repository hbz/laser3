                ...
                <tr class="">
                    ...
                    <td>
                        ...
                        <g:elseif test="${participant.oldSub && participant.oldCustomProperty}">
                            ...
                            <g:elseif test="${participant.oldCustomProperty.type.type == BigDecimal.toString()}">
                                <semui:xEditable owner="${participant.oldCustomProperty}" type="text"
                                                 overwriteEditable="${false}"
                                                 field="decValue"/>
                            </g:elseif>
                            ...
                            <g:elseif test="${participant.oldCustomProperty.type.type == URL.toString()}">
                                <semui:xEditable owner="${participant.oldCustomProperty}" type="url" field="urlValue"
                                                 overwriteEditable="${false}"
                            ...
                            <g:elseif test="${participant.oldCustomProperty.type.type == RefdataValue.toString()}">
                        ...
                        <td class="center aligned">
                            <g:if test="${participant.surveyProperty}">
                                ...
                                <g:elseif test="${participant.surveyProperty.type.type == URL.toString()}">
                                    <semui:xEditable owner="${participant.surveyProperty}" type="url" field="urlValue"
                                                     overwriteEditable="${false}"
                    ...
                    <td>
                        <g:if test="${participant.newCustomProperty}">
                            ...
                            <g:elseif test="${participant.newCustomProperty.type.type == BigDecimal.toString()}">
                                <semui:xEditable owner="${participant.newCustomProperty}" type="text"
                                                 overwriteEditable="${false}"
                                                 field="decValue"/>
                            </g:elseif>
                            ...
                            <g:elseif test="${participant.newCustomProperty.type.type == URL.toString()}">
                                <semui:xEditable owner="${participant.newCustomProperty}" type="url" field="urlValue"
                                                 overwriteEditable="${false}"
                            ...
                            <g:elseif test="${participant.newCustomProperty.type.type == RefdataValue.toString()}">
