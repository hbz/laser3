<%@ page import="de.laser.interfaces.CalculatedType; de.laser.helper.RDStore; de.laser.interfaces.CalculatedType; com.k_int.kbplus.License; com.k_int.kbplus.Org" %>
...
<semui:actionsDropdown>
    ...
    <g:if test="${editable || accessService.checkPermAffiliation('ORG_INST,ORG_CONSORTIUM','INST_EDITOR')}">
        ...
        <g:if test="${actionName == 'show'}">
            <g:if test="${(license.getLicensingConsortium()?.id == org.id) || (license.getCalculatedType() == de.laser.interfaces.CalculatedType.CALCULATED_TYPE_LOCAL && license.getLicensee()?.id == org.id)}">
                <div class="divider"></div>
