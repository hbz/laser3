<%@ page import="de.laser.License;de.laser.DocContext;com.k_int.kbplus.Subscription;de.laser.helper.RDStore;de.laser.helper.RDConstants;de.laser.properties.PropertyDefinition;de.laser.interfaces.CalculatedType" %>
<!doctype html>
