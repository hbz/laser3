                                    ...
                                    <div class="ui list">
                                        <div class="item">
                                            ...
                                            <g:render template="/address/formModal"
                                                      model="['orgId': orgInstance?.id, 'redirect': '.', modalId: 'addressFormModalPostalAddress', typeId: RDStore.ADRESS_TYPE_POSTAL, hideType: true]"/>
                                            ...
                                            <g:render template="/address/formModal"
                                                      model="['orgId': orgInstance?.id, 'redirect': '.', modalId: 'addressFormModalBillingAddress', typeId: RDStore.ADRESS_TYPE_BILLING, hideType: true]"/>
                                        </div>
                                        ...
                                        <div class="item">
                                            ...
                                            <g:render template="/address/formModal"
                                                      model="['orgId': orgInstance?.id, 'redirect': '.', modalId: 'addressFormModalLegalPatronAddress', typeId: RDStore.ADRESS_TYPE_LEGAL_PATRON, hideType: true]"/>
