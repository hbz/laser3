				...
				<g:if test="${organisationMatches != null}">
					<g:if test="${organisationMatches.size()>0}">
						...
						<g:if test="${params.proposedOrganisation && !params.proposedOrganisation.isEmpty()}">
							<semui:msg class="warning" message="${message(code:'org.findInstitutionMatches.match', args:[params.proposedOrganisation])}" />
						...
						<g:else if="${params.proposedOrganisation.isEmpty()}">
							<semui:msg class="warning" message="{message(code:'org.findInstitutionMatches.matchNoName', args:[params.proposedOrganisation])}" />

						</g:else>
					</g:if>
					<g:elseif test="${params.proposedOrganisation && !params.proposedOrganisation.isEmpty()}">
						<g:if test="${comboType == RDStore.COMBO_TYPE_CONSORTIUM}">
							<semui:msg class="warning" message="${message(code:'org.findInstitutionMatches.no_match', args:[params.proposedOrganisation])}" />
						...
						<g:elseif test="${comboType == RDStore.COMBO_TYPE_DEPARTMENT}">
							<semui:msg class="warning" message="${message(code:'org.findDepartmentMatches.no_match', args:[params.proposedOrganisation])}" />
					...
					<g:elseif test="${params.proposedOrganisationID && !params.proposedOrganisationID.isEmpty()}">
						<semui:msg class="warning" message="${message(code:'org.findInstitutionMatches.no_id_match', args:[params.proposedOrganisationID])}" />
					</g:elseif>
				</g:if>
