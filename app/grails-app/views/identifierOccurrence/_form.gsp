...
<div class="field fieldcontain ${hasErrors(bean: identifierOccurrenceInstance, field: 'org', 'error')} ">
	<label for="org">
...
<div class="field fieldcontain ${hasErrors(bean: identifierOccurrenceInstance, field: 'ti', 'error')} ">
	<label for="ti">
...
<div class="field fieldcontain ${hasErrors(bean: identifierOccurrenceInstance, field: 'tipp', 'error')} ">
	<label for="tipp">
...
<div class="field fieldcontain ${hasErrors(bean: identifierOccurrenceInstance, field: 'identifier', 'error')} required">
