<!-- _copyModal.gsp -->
<%@ page import="de.laser.finance.CostItem;de.laser.finance.CostItemGroup;de.laser.BudgetCode;com.k_int.kbplus.Subscription;com.k_int.kbplus.OrgRole;com.k_int.kbplus.RefdataValue" %>
