<!-- _copyModal.gsp -->
<%@ page import="de.laser.finance.CostItem;de.laser.finance.CostItemGroup;de.laser.finance.BudgetCode;com.k_int.kbplus.Subscription;de.laser.OrgRole;de.laser.RefdataValue" %>
