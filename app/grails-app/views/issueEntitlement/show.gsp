...
<div class="inline-lists">
    ...
    <h3 class="ui header"><strong><g:message
            code="issueEntitlement.subscription_access.label"/></strong> : ${issueEntitlementInstance.subscription.name}
    </h3>
    ...
    <h3 class="ui header">
        <strong><g:message
                code="issueEntitlement.package_defaults.label"/></strong> : ${issueEntitlementInstance.tipp.pkg.name}
    </h3>
            ...
            <g:each in="${tippList}" var="t">
                <g:each in="${t.coverages}" var="tippCoverage">
                    <tr>
                        ...
                        <td><g:link controller="tipp" action="show"
