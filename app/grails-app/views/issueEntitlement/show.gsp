    ...
    <div class="container">
        ...
        <div class="inline-lists">
            ...
            <g:if test="${issueEntitlementInstance?.subscription.owner}">
                <dt><g:message code="licence.label" default="Licence" /></dt>
            ...
            <g:if test="${issueEntitlementInstance?.subscription?.owner?.onixplLicense}">
                <dt><g:message code="onixplLicence.label" default="ONIX-PL Licence" /></dt>
...
<!--                            <g:if test="${i.identifier.ns.ns.equalsIgnoreCase('issn')}">
              ...
              <dd> 
                ...
                <g:if test="${issueEntitlementInstance?.tipp.hostPlatformURL}">
                    <dt>${message(code:'tipp.host_link', default:'Title URL')}</dt>
            ...
            <table class="table table-bordered table-striped">
                <tr>
                    ...
                    <th>${message(code:'tipp.to_date', default:'To Date')}</th><th>${message(code:'tipp.to_volume', default:'To Volume')}</th><th>${message(code:'tipp.to_issue', default:'To Issue')}</th>
                </tr>
                <tr>
