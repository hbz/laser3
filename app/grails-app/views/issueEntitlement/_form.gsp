...
<div class="field fieldcontain ${hasErrors(bean: issueEntitlementInstance, field: 'status', 'error')} ">
	<label for="status">
...
<div class="field fieldcontain ${hasErrors(bean: issueEntitlementInstance, field: 'startVolume', 'error')} ">
...
<div class="field fieldcontain ${hasErrors(bean: issueEntitlementInstance, field: 'startIssue', 'error')} ">
...
<div class="field fieldcontain ${hasErrors(bean: issueEntitlementInstance, field: 'endDate', 'error')} ">
	<label for="endDate">
...
<div class="field fieldcontain ${hasErrors(bean: issueEntitlementInstance, field: 'endVolume', 'error')} ">
	<label for="endVolume">
...
<div class="field fieldcontain ${hasErrors(bean: issueEntitlementInstance, field: 'endIssue', 'error')} ">
	<label for="endIssue">
...
<div class="field fieldcontain ${hasErrors(bean: issueEntitlementInstance, field: 'embargo', 'error')} ">
	<label for="embargo">
...
<div class="field fieldcontain ${hasErrors(bean: issueEntitlementInstance, field: 'coverageDepth', 'error')} ">
...
<div class="field fieldcontain ${hasErrors(bean: issueEntitlementInstance, field: 'coverageNote', 'error')} ">
...
<div class="field fieldcontain ${hasErrors(bean: issueEntitlementInstance, field: 'ieReason', 'error')} ">
	<label for="ieReason">
