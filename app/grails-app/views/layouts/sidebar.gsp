    ...
    <div id="sidebar">
        ...
        <g:if test="${user}">
            ...
            <g:if test="${usaf && usaf.size() > 0}">
                <div id="sidebar-context-switcher" class="dropdown">
                    <button class="btn btn-primary dropdown-toggle" type="button" id="contextSwitcher" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        Switch Context
                        <span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu" >
                        <g:each in="${usaf}" var="org">
                            <li><a href="#" class="dropdown-toggle" data-context="#sidebar-context-${org.id}" data-toggle="dropdown">${org.name} </a></li>
                        </g:each>
                        <li><a href="#" class="dropdown-toggle" data-context="#sidebar-context-datamanager" data-toggle="dropdown">${message(code:'menu.datamanager')} </a></li>
                        <li><a href="#" class="dropdown-toggle" data-context="#sidebar-context-admin" data-toggle="dropdown">${message(code:'menu.admin')} </a></li>
                        <li><a href="#" class="dropdown-toggle" data-context="#sidebar-context-demo" data-toggle="dropdown">${message(code:'menu.demo')} </a></li>
                        <li><a href="#" class="dropdown-toggle" data-context="#sidebar-context-dataexplorer" data-toggle="dropdown">${message(code:'menu.dataexplorer')} </a></li>
                    </ul>
                </div>
                <r:script disposition="defer">
                    if(localStorage.getItem('sidebar-context')){
                        $('#sidebar .list-group').hide()
                        $('#sidebar ' + localStorage.getItem('sidebar-context')).show()
                    }
                    $('#sidebar-context-switcher ul a').click(function(){
                        $('#sidebar .list-group').hide()
                        $('#sidebar ' + $(this).data('context')).show()
                        localStorage.setItem('sidebar-context', $(this).data('context'))
                    })
                </r:script>
            </g:if>
            ...
            <g:if test="${usaf && usaf.size() > 0}">
                <g:each in="${usaf}" var="org">
                    <ul id="sidebar-context-${org.id}" class="list-group">
            ...
            <!-- data manager -->
            <sec:ifAnyGranted roles="ROLE_ADMIN,KBPLUS_EDITOR">
                <ul id="sidebar-context-datamanager" class="list-group">
                    <li <%= ( ( 'dataManager'== controllerName ) && ( 'index'==actionName ) ) ? ' class="active"' : '' %>>
                        <g:link controller="dataManager" action="index">${message(code:'menu.datamanager.dash')}</g:link></li>
                    <li class="divider"></li>
                    <li <%= ( ( 'announcement'== controllerName ) && ( 'index'==actionName ) ) ? ' class="active"' : '' %>>
                    ...
                    <li<%= ( ( 'subscriptionDetails'== controllerName ) && ( 'compare'==actionName ) ) ? ' class="active"' : '' %>>
                        <g:link controller="subscriptionDetails" action="compare">${message(code:'menu.datamanager.compareSubscriptions')}</g:link></li>
            ...
            <!-- admin -->
            <sec:ifAnyGranted roles="ROLE_ADMIN">
                <ul id="sidebar-context-admin" class="list-group">
                    <li <%= ( ( 'admin'== controllerName ) && ( 'manageAffiliationRequests'==actionName ) ) ? ' class="active"' : '' %>>
                        <g:link controller="admin" action="manageAffiliationRequests">Manage Affiliation Requests</g:link></li>
                    <li <%= ( ( 'admin'== controllerName ) && ( 'settings'==actionName ) ) ? ' class="active"' : '' %>>
                        <g:link controller="admin" action="settings">System Settings</g:link></li>
            ...
            <sec:ifAnyGranted roles="ROLE_ADMIN,KBPLUS_EDITOR">
                <ul id="sidebar-context-demo" class="list-group">
                    <li><g:link controller="address" action="index">Address Controller</g:link></li>
                    <li><g:link controller="cluster" action="index">Cluster Controller</g:link></li>
                    <li><g:link controller="contact" action="index">Contact Controller</g:link></li>
                    <li><g:link controller="person" action="index">Person Controller</g:link></li>
            ...
            <g:if test="${true}">
                <ul id="sidebar-context-dataexplorer" class="list-group">
                    <li<%= request.forwardURI == "${createLink(uri: '/home/search')}" ? ' class="active"' : '' %>><a href="${createLink(uri: '/home/search')}">Search</a></li>
                    <li <%='package'== controllerName ? ' class="active"' : '' %>><g:link controller="package">Package</g:link></li>
                    <li <%='org'== controllerName ? ' class="active"' : '' %>><g:link controller="org">Organisations</g:link></li>
                    <li <%='platform'== controllerName ? ' class="active"' : '' %>><g:link controller="platform">Platform</g:link></li>
