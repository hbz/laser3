            ...
            <g:if test="${accessService.checkPerm("ORG_CONSORTIUM")}">
                <div class="field">
                    ...
                    <select id="asOrgType" name="asOrgType" class="ui dropdown">
                        <g:each in="${com.k_int.kbplus.RefdataValue.executeQuery('select rdv from RefdataValue as rdv where rdv.value in (:wl) and rdv.owner.desc = :ot', [wl:['Consortium', 'Institution'], ot: de.laser.helper.RDConstants.ORG_TYPE])}" var="opt">
