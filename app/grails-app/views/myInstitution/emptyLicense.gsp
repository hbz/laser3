            ...
            <%-- <g:if test="${accessService.checkPerm("ORG_CONSORTIUM")}">
                <div class="field">
                    ...
                    <select id="asOrgType" name="asOrgType" class="ui dropdown">
                        <g:each in="${de.laser.RefdataValue.executeQuery('select rdv from RefdataValue as rdv where rdv.value in (:wl) and rdv.owner.desc = :ot', [wl:['Consortium', 'Institution'], ot: RDConstants.ORG_TYPE])}" var="opt">
