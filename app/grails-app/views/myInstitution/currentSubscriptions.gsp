...
<%--
            ...
            <div class="field disabled fieldcontain">
                ...
                <laser:select name="status" class="ui dropdown"
                              from="${RefdataCategory.getAllRefdataValues(de.laser.helper.RDConstants.SUBSCRIPTION_STATUS)}"
                              optionKey="id"
                              optionValue="value"
        ...
        <div class="field">
                <fieldset id="subscritionType">
                    ...
                    <div class="inline fields la-filter-inline">
                        <%
                            List subTypes = RefdataCategory.getAllRefdataValues(de.laser.helper.RDConstants.SUBSCRIPTION_TYPE)
                ...
                <td class="x">
                    ...
                    <%--<g:if test="${ contextService.getUser().isAdmin() || contextService.getUser().isYoda() ||
                        ...
                        <g:if test="${editable && accessService.checkPermAffiliationX("ORG_INST,ORG_CONSORTIUM","INST_EDITOR","ROLE_ADMIN")}">
                            ...
                            <g:if test="${CostItem.findBySub(s) || CostItem.findAllBySubInListAndOwner(Subscription.findAllByInstanceOfAndStatusNotEqual(s, RefdataValue.getByValueAndCategory('Deleted', de.laser.helper.RDConstants.SUBSCRIPTION_STATUS)), institution)}">
