...
<semui:controlButtons>
    <semui:exportDropdown>
        ...
        <g:else>
            <semui:exportDropdownItem>
                <g:link class="item" action="manageConsortia" params="${params+[exportXLS:true]}">${message(code:'default.button.exports.xls')}</g:link>
            </semui:exportDropdownItem>
            <semui:exportDropdownItem>
                <g:link class="item" action="manageConsortia" params="${params+[format:'csv']}">${message(code:'default.button.exports.csv')}</g:link>
            </semui:exportDropdownItem>
        </g:else>
    </semui:exportDropdown>
