		...
		<div id="list-group" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="group.owner.label" default="Owner" /></th>
						...
						<th><g:message code="group.type.label" default="Type" /></th>
				...
				<g:each in="${groupInstanceList}" status="i" var="groupInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${groupInstance.id}">${fieldValue(bean: groupInstance, field: "owner")}</g:link></td>
