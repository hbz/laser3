...
<html>
  ...
  <body>
        ...
        <h1 class="ui icon header la-clear-before la-noMargin-top"><semui:headerIcon />Titles Import - Create/Add Identifiers</h1>
        ...
        <g:form action="titlesImport" method="post" enctype="multipart/form-data">
          <p>
            ...
            <p>The last of these can be repeated for each type of identifier in the file, with the 'namespace' being replaced by the type of identifier (e.g. title.id.ISSN, title.id.eISSN)<br/>
