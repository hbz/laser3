...
<html>
  ...
  <body>
    <div>
          ...
          <h1 class="ui left floated aligned icon header la-clear-before"><semui:headerIcon /><g:message code="default.list.label" args="[entityName]" /> (Showing ${titleInstancePackagePlatformInstanceTotal})...
