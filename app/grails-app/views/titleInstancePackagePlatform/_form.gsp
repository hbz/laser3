...
<div class="field fieldcontain ${hasErrors(bean: titleInstancePackagePlatformInstance, field: 'startDate', 'error')} ">
	<label for="startDate">
...
<div class="field fieldcontain ${hasErrors(bean: titleInstancePackagePlatformInstance, field: 'startVolume', 'error')} ">
...
<div class="field fieldcontain ${hasErrors(bean: titleInstancePackagePlatformInstance, field: 'startIssue', 'error')} ">
...
<div class="field fieldcontain ${hasErrors(bean: titleInstancePackagePlatformInstance, field: 'endDate', 'error')} ">
	<label for="endDate">
...
<div class="field fieldcontain ${hasErrors(bean: titleInstancePackagePlatformInstance, field: 'endVolume', 'error')} ">
	<label for="endVolume">
...
<div class="field fieldcontain ${hasErrors(bean: titleInstancePackagePlatformInstance, field: 'endIssue', 'error')} ">
	<label for="endIssue">
...
<div class="field fieldcontain ${hasErrors(bean: titleInstancePackagePlatformInstance, field: 'embargo', 'error')} ">
	<label for="embargo">
...
<div class="field fieldcontain ${hasErrors(bean: titleInstancePackagePlatformInstance, field: 'coverageDepth', 'error')} ">
...
<div class="field fieldcontain ${hasErrors(bean: titleInstancePackagePlatformInstance, field: 'coverageNote', 'error')} ">
...
<div class="field fieldcontain ${hasErrors(bean: titleInstancePackagePlatformInstance, field: 'pkg', 'error')} required">
	<label for="pkg">
...
<div class="field fieldcontain ${hasErrors(bean: titleInstancePackagePlatformInstance, field: 'platform', 'error')} required">
	<label for="platform">
...
<div class="field fieldcontain ${hasErrors(bean: titleInstancePackagePlatformInstance, field: 'title', 'error')} required">
	<label for="title">
