            ...
            <div class="ui card">
              <div class="content">
                ...
                <dl>
                  ...
                  <dd><semui:xEditableRefData owner="${platformInstance}" field="serviceProvider" config="${de.laser.helper.RDConstants.Y_N}"/></dd>
                </dl>
                <dl>
                  <dt>${message(code: 'platform.softwareProvider', default: 'Software Provider')}</dt>
                  <dd><semui:xEditableRefData owner="${platformInstance}" field="softwareProvider" config="${de.laser.helper.RDConstants.Y_N}"/></dd>
                </dl>
                <g:if test="${params.mode == 'advanced'}">
                  <dl>
                    <dt>${message(code: 'platform.type', default: 'Type')}</dt>
                    <dd><semui:xEditableRefData owner="${platformInstance}" field="type" config="${de.laser.helper.RDConstants.Y_N_O}"/></dd>
                  </dl>
                  <dl>
                    <dt>${message(code: 'platform.status', default: 'Status')}</dt>
                    <dd><semui:xEditableRefData owner="${platformInstance}" field="status"
                                                config="${de.laser.helper.RDConstants.USAGE_STATUS}"/></dd>
                  </dl>
                  <dl>
