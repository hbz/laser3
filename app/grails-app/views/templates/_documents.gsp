<div class="well documents">
  <h5>${message(code:'licence.documents')}</h5>
  <ul>
  ...
  <g:if test="${editable}">
    <input type="submit" class="btn btn-primary" value="${message(code:'licence.addNewDocument')}" data-toggle="modal" href="#modalCreateDocument" />
