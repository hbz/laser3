<%@ page import="de.laser.ApiSource; de.laser.SurveyOrg; de.laser.helper.RDStore; com.k_int.kbplus.Subscription; com.k_int.kbplus.Platform; de.laser.titles.BookInstance" %>
<!doctype html>
<html>
<head>
