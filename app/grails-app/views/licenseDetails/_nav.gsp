...
<ul class="nav nav-pills">
    ...
    <li <%='additionalInfo'== actionName ? ' class="active"' : '' %>><g:link controller="licenseDetails"
                                                                             ...
                                                                             params="${[id:params.id]}">${message(code:'licence.additionalInformation')}</g:link></li>
