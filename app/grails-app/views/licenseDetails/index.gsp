    ...
    <div class="container">
            <div class="row">
                ...
                <g:hasErrors bean="${titleInstanceInstance}">
                  ...
                  <sec:ifAnyGranted roles="ROLE_ADMIN,KBPLUS_EDITOR">
                    <dl>
                        ...
                        <dd>
                            ...
                            <g:else>
                                <g:link class="btn btn-warning" controller='licenseImport' action='doImport' params='[license_id: license.id]'>${message(code:'licence.importONIX-PLlicence')}</g:link>
                            </g:else>
                        </dd>
                    </dl>
                  </sec:ifAnyGranted>
                  ...
                  <dl>
                      <dt><label class="control-label" for="licenseeRef">${message(code:'licence.incomingLicenceLinks')}</label></dt>
