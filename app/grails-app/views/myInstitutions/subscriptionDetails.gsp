              ...
              <table  class="table table-striped table-bordered table-condensed">
                ...
                <g:each in="${entitlements}" var="ie">
                  <tr>
                    ...
                    <td>
                        <span><g:formatDate format="${message(code:'default.date.format.notime')}" date="${ie.startDate}"/></span>
                        <input id="IssueEntitlement:${ie.id}:startDate" type="hidden" class="dp1" />
                    </td>
                    <td><span><g:formatDate format="${message(code:'default.date.format.notime')}" date="${ie.endDate}"/></span>
