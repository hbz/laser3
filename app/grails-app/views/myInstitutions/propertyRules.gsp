...
<html>
    ...
    <body>
        ...
        <div class="container">
		    ...
		    <li>
			    <g:link controller="myInstitutions" action="propertyRules" params="${[shortcode:params.shortcode]}">${message(code: 'menu.institutions.manage_props', default: 'Manage Property Rules')}</g:link>
		    </li>
        </ul>
    </div>
