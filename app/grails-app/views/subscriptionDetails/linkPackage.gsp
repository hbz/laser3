...
%{--          <g:if test="${(com.k_int.kbplus.RefdataValue.getByValueAndCategory('Consortium', 'OrgRoleType') in  institution?.orgRoleType) && (com.k_int.kbplus.Subscription.findAllByInstanceOf(com.k_int.kbplus.Subscription.get(params.id)).size() > 0) }">
