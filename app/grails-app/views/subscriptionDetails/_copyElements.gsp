    ...
    <g:form action="copyElementsIntoSubscription" controller="subscriptionDetails" id="${params.id}"
        ...
        <table class="ui celled table table-tworow la-table">
            ...
            <tbody>
                ...
                <tr>
                    <td></td>
                    <td class="center aligned"><div class="ui radio checkbox la-toggle-radio la-replace"><input type="radio" name="subscription.takeOwner" value="${REPLACE}" /></div></td>
                    <td class="center aligned"><div class="ui radio checkbox la-toggle-radio la-noChange"><input type="radio" name="subscription.takeOwner" value="${DO_NOTHING}" checked /></div></td>
                    <td>
                ...
                <tr>
                    <td class="center aligned"><div class="ui radio checkbox la-toggle-radio la-append"><input type="radio" name="subscription.takeOrgRelations" value="${COPY}" /></div></td>
                    <td class="center aligned"><div class="ui radio checkbox la-toggle-radio la-replace"><input type="radio" name="subscription.takeOrgRelations" value="${REPLACE}" /></div></td>
                    <td class="center aligned"><div class="ui radio checkbox la-toggle-radio la-noChange"><input type="radio" name="subscription.takeOrgRelations" value="${DO_NOTHING}" checked /></div></td>
                    <td>
                ...
                <tr>
                    <td class="center aligned"><div class="ui radio checkbox la-toggle-radio la-append"><input type="radio" name="subscription.takePackages" value="${COPY}" /></div></td>
                    <td class="center aligned"><div class="ui radio checkbox la-toggle-radio la-replace"><input type="radio" name="subscription.takePackages" value="${REPLACE}" /></div></td>
                    <td class="center aligned"><div class="ui radio checkbox la-toggle-radio la-noChange"><input type="radio" name="subscription.takePackages" value="${DO_NOTHING}" checked /></div></td>
                    <td>
                        <g:each in="${sourceSubscription?.packages?.sort { it.pkg?.name }}" var="sp">
            ...
            <tr>
                ...
                <td class="center aligned" style="vertical-align: top" name="subscription.takeOwner.source">
                    <div>
                        <g:if test="${sourceSubscription?.owner}">
                            <b>${message(code: 'license')}:</b>
                            <g:link controller="licenseDetails" action="show" target="_blank" id="${sourceSubscription.owner.id}">
            ...
            <tr>
                ...
                <td class="center aligned" style="vertical-align: top" name="subscription.takeOrgRelations.source">
                    <div>
                        <g:each in="${source_visibleOrgRelations}" var="source_role">
                            <g:if test="${source_role.org}">
                                <b>${source_role?.roleType?.getI10n("value")}:</b>
