...
<body>
    ...
    <br />
    <g:link class="ui button red" controller="yoda" action="migrateCollectiveSubscriptions" params="${[cmd:'migrate']}">Migriere Subscriber/Subscriber_Consortial zu 'Subscription Collective'</g:link>
