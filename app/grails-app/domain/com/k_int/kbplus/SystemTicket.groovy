...
class SystemTicket {
    ...
    static mapping = {
        ...
        described   column:'sti_described'
        expected    column:'sti_expected'
        info        column:'sti_info'
        meta        column:'sti_meta'
    ...
    static constraints = {
        ...
        described   (nullable:false, blank:true)
        expected    (nullable:false, blank:true)
        info        (nullable:false, blank:true)
