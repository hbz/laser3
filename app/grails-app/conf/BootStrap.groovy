    ...
    def init = { servletContext ->
        ...
        */
        ...
        if(!Org.findAll() && !Person.findAll() && !Address.findAll() && !Contact.findAll()) {
            ...
            try {
                def orgBase = new XmlSlurper().parse(new File("../import/org_data_dumps/orgData_dump.xml")) //temp, name should be generalised later
            ...
            log.error("Data available, skipping ...")
            //System.exit(42)
        }
