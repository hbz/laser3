databaseChangeLog = {
	...
	changeSet(author: "galffy (hand-coded)", id: "1595574486444-1") {
		grailsChange {
			change {
	...
	changeSet(author: "galffy (hand-coded)", id: "1595574486444-2") {
		grailsChange {
			change {
	...
	/*
	changeSet(author: "galffy (hand-coded)", id: "1595574486444-3") {
		grailsChange {
			change {
